...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 29, 2017 at 07:45 AM
...
(3, 'Supervisor', 1, 'Supervisor', 'Supervisor', NULL, 'A', '21', '21', '2016-04-08', '2016-04-08', '1', '1', '1', '1'),
(4, 'Operator', 1, 'Operator', 'Operator', NULL, 'A', '21', '21', '2016-04-08', '2016-04-08', '1', '1', '1', '1');
...
--
-- Table structure for table `tbl_bill_of_material_dtl`
--

CREATE TABLE `tbl_bill_of_material_dtl` (
  `bill_of_material_dtl_id` int(200) NOT NULL,
  `item_name` varchar(200) NOT NULL,
  `product_name` varchar(200) NOT NULL,
  `quentity` varchar(200) NOT NULL,
  `unit` varchar(200) NOT NULL,
  `gross_weight` varchar(200) NOT NULL,
  `net_weight` varchar(200) NOT NULL,
  `scrap_weight` varchar(200) NOT NULL,
  `bill_of_material_hdr_id` varchar(200) NOT NULL,
...
--
-- Dumping data for table `tbl_bill_of_material_dtl`
--

INSERT INTO `tbl_bill_of_material_dtl` (`bill_of_material_dtl_id`, `item_name`, `product_name`, `quentity`, `unit`, `gross_weight`, `net_weight`, `scrap_weight`, `bill_of_material_hdr_id`, `sub_total`, `service_charge_percentage`, `service_charge`, `gross_discount_percentage`, `gross_discount`, `grand_total`, `maker_id`, `maker_date`, `author_id`, `author_date`, `status`, `comp_id`, `zone_id`, `brnh_id`, `divn_id`) VALUES
(1, '13', '15', '500', 'KG', '137.415', '137.415', '0.3', '3', '', NULL, NULL, NULL, NULL, '', '1', '0000-00-00', NULL, '2017-04-27', 'A', '1', '1', '1', NULL),
(2, '14', '15', '500', 'KG', '137.445', '137.445', '0.2', '3', '', NULL, NULL, NULL, NULL, '', '1', '0000-00-00', NULL, '2017-04-27', 'A', '1', '1', '1', NULL),
(3, '13', '15', '1000', 'KG', '0.11', '0.11', '0.6', '4', '', NULL, NULL, NULL, NULL, '', '1', '0000-00-00', NULL, '2017-04-27', 'A', '1', '1', '1', NULL),
(4, '14', '15', '1000', 'KG', '0.18', '0.18', '0.8', '4', '', NULL, NULL, NULL, NULL, '', '1', '0000-00-00', NULL, '2017-04-27', 'A', '1', '1', '1', NULL),
(5, '13', '15', '1000', 'KG', '0.17', '0.17', '0.01', '5', '', NULL, NULL, NULL, NULL, '', '1', '0000-00-00', NULL, '2017-04-28', 'A', '1', '1', '1', NULL),
(6, '14', '15', '1000', 'KG', '0.11', '0.11', '0', '5', '', NULL, NULL, NULL, NULL, '', '1', '0000-00-00', NULL, '2017-04-28', 'A', '1', '1', '1', NULL),
(7, '13', '15', '500', 'KG', '0.085', '0.085', '0.005', '6', '', NULL, NULL, NULL, NULL, '', '1', '0000-00-00', NULL, '2017-04-28', 'A', '1', '1', '1', NULL),
(8, '14', '15', '500', 'KG', '0.055', '0.055', '0', '6', '', NULL, NULL, NULL, NULL, '', '1', '0000-00-00', NULL, '2017-04-28', 'A', '1', '1', '1', NULL),
(9, '13', '15', '900', 'KG', '0.153', '0.153', '0.009', '7', '', NULL, NULL, NULL, NULL, '', '1', '0000-00-00', NULL, '2017-04-28', 'A', '1', '1', '1', NULL),
(10, '14', '15', '900', 'KG', '0.099', '0.099', '0', '7', '', NULL, NULL, NULL, NULL, '', '1', '0000-00-00', NULL, '2017-04-28', 'A', '1', '1', '1', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `tbl_bill_of_material_hdr`
--

CREATE TABLE `tbl_bill_of_material_hdr` (
  `bill_of_material_id_hdr` int(200) NOT NULL,
  `product_type` varchar(200) NOT NULL,
  `product_code` varchar(200) DEFAULT NULL,
  `product_name` varchar(200) NOT NULL,
  `bom_no` varchar(200) DEFAULT NULL,
  ...
  `author_date` date DEFAULT NULL,
  `status` varchar(200) DEFAULT 'A',
  `approval_status` varchar(200) NOT NULL DEFAULT 'Not Approve',
  `comp_id` varchar(200) DEFAULT NULL,
  `zone_id` varchar(200) DEFAULT NULL,
  `brnh_id` varchar(200) DEFAULT NULL,
  `divn_id` varchar(200) DEFAULT NULL
...
--
-- Dumping data for table `tbl_bill_of_material_hdr`
--

INSERT INTO `tbl_bill_of_material_hdr` (`bill_of_material_id_hdr`, `product_type`, `product_code`, `product_name`, `bom_no`, `date`, `remark`, `quantity`, `serial_no`, `maker_id`, `maker_date`, `author_id`, `author_date`, `status`, `approval_status`, `comp_id`, `zone_id`, `brnh_id`, `divn_id`) VALUES
(5, 'finish_goods', '', '15', '0', '2017-04-28', 'note', '1000', '001', '1', '2017-04-28', NULL, '2017-04-28', 'A', 'Approved', '1', '1', '1', '1'),
(6, 'finish_goods', '', '15', '0', '2017-04-28', 'req', '500', '002', '1', '2017-04-28', NULL, '2017-04-28', 'A', 'Approved', '1', '1', '1', '1'),
(7, 'finish_goods', '', '15', '0', '2017-04-28', 'note', '900', '005', '1', '2017-04-28', NULL, '2017-04-28', 'A', 'Approved', '1', '1', '1', '1');
...
INSERT INTO `tbl_contact_m` (`contact_id`, `addres_id`, `first_name`, `group_name`, `accunt`, `middle_name`, `alias`, `printname`, `last_name`, `email`, `phone`, `mobile`, `address1`, `address3`, `opening_balance`, `previous_balance`, `transport`, `station`, `contact_person`, `IT_Pan`, `ward`, `lst`, `cst`, `tin`, `fax`, `maker_id`, `maker_date`, `author_id`, `author_date`, `status`, `comp_id`, `zone_id`, `brnh_id`, `divn_id`, `ledgertype`) VALUES
(16, '', 'safi', '3', '0', '', '0', '0', '', 'collestbablu@gmail.com', '', '9716127292', ' \r\n', ' \r\n', '', '0', '0', '0', 'safi khan', '', '', '110059', '', '', '9716127292', '1', '2017-04-25', '1', '2017-04-25', 'A', '1', '1', '1', '1', '0'),
(17, '', 'anoj', '4', '0', '', '0', '0', '', 'collestbablu@gmail.com', '', '9716127292', ' \r\n', ' \r\n', '', '0', '0', '0', 'safi khan', '', '', '110059', '', '', '9716127292', '1', '2017-04-25', '1', '2017-04-25', 'A', '1', '1', '1', '1', '0'),
(18, '', 'ravi', '3', '0', '', '0', '0', '', 'collestbablu@gmail.com', '', '9716127292', ' \r\n', ' \r\n', '', '0', '0', '0', 'safi khan', '', '', '110059', '', '', '9716127292', '1', '2017-04-25', '1', '2017-04-25', 'A', '1', '1', '1', '1', '0'),
(19, '', 'nipti', '4', '0', '', '0', '0', '', 'collestbablu@gmail.com', '', '9716127292', ' \r\n', ' \r\n', '', '0', '0', '0', 'safi khan', '', '', '110059', '', '', '9716127292', '1', '2017-04-25', '1', '2017-04-25', 'A', '1', '1', '1', '1', '0'),
(20, '', 'SANTOSH', '4', '0', '', '0', '0', '', '', '', '9999004228', ' \r\n', ' \r\n', '', '0', '0', '0', '', '', '', '110059', '', '', '', '1', '2017-04-26', '1', '2017-04-26', 'A', '1', '1', '1', '1', '0'),
(21, '', 'JAI PRAKASH', '3', '0', '', '0', '0', '', '', '', '9826099894', ' \r\n', ' \r\n', '', '0', '0', '0', '', '', '', '', '', '', '', '1', '2017-04-26', '1', '2017-04-26', 'A', '1', '1', '1', '1', '0'),
(22, '', 'raj', '3', '0', '', '0', '0', '', 'hy@gmail.com', '', '99999999', 'hhj \r\n', ' \r\n', '', '0', '0', '0', '', '', '', '', '', '', '', '1', '2017-04-26', '1', '2017-04-26', 'A', '1', '1', '1', '1', '0'),
(23, '', 'dev', '3', '0', '', '0', '0', '', 'rvkumar5702@gmail.com', '', '9716183447', ' \r\n', ' \r\n', '', '0', '0', '0', '', '', '', '', '', '', '', '1', '2017-04-28', '1', '2017-04-28', 'A', '1', '1', '1', '1', '0');
...
--
-- Table structure for table `tbl_defleshing_hdr`
--

CREATE TABLE `tbl_defleshing_hdr` (
  `wip_hdr_id` int(200) NOT NULL,
  `product_type` varchar(200) NOT NULL,
  `product_name` varchar(200) NOT NULL,
  `date` varchar(200) NOT NULL,
  ...
  `lumbs` varchar(200) NOT NULL,
  `act_hour` varchar(200) NOT NULL,
  `qty_made` varchar(200) NOT NULL,
  `rejection_qty` varchar(200) NOT NULL,
  `quantity` varchar(200) NOT NULL,
  `maker_id` varchar(200) DEFAULT NULL,
  `maker_date` date DEFAULT NULL,
  `author_id` varchar(200) DEFAULT NULL,
...
--
-- Dumping data for table `tbl_defleshing_hdr`
--

INSERT INTO `tbl_defleshing_hdr` (`wip_hdr_id`, `product_type`, `product_name`, `date`, `lot_no`, `scrap`, `hours`, `lumbs`, `act_hour`, `qty_made`, `rejection_qty`, `quantity`, `maker_id`, `maker_date`, `author_id`, `author_date`, `status`, `comp_id`, `zone_id`, `brnh_id`, `divn_id`) VALUES
(1, '', '15', '17-04-28', '001', '0', '4', '0', '2000', '1000', '', '998', '1', '2017-04-28', NULL, NULL, 'A', '1', '1', '1', '1'),
(2, '', '15', '17-04-28', '002', '0', '34', '0', '402', '495', '', '201', '1', '2017-04-28', NULL, NULL, 'A', '1', '1', '1', '1');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_defleshing_log`
--

CREATE TABLE `tbl_defleshing_log` (
  `wip_log_id` int(200) NOT NULL,
  `bom_id` varchar(200) NOT NULL,
  ...
  `quantity` varchar(200) NOT NULL,
  `scrap` varchar(200) DEFAULT NULL,
  `rejection_qty` varchar(200) NOT NULL,
  ...
  `rejection_status` varchar(200) NOT NULL DEFAULT 'Rejection Not Done',
  `maker_id` varchar(200) DEFAULT NULL,
  `maker_date` date DEFAULT NULL,
  `author_id` varchar(200) DEFAULT NULL,
  `author_date` date DEFAULT NULL,
...
--
-- Dumping data for table `tbl_defleshing_log`
--

INSERT INTO `tbl_defleshing_log` (`wip_log_id`, `bom_id`, `p_id`, `lot_no`, `machine_id`, `date`, `shift`, `quantity`, `scrap`, `rejection_qty`, `operator`, `supervisor`, `hours`, `lumbs`, `act_hour`, `stage`, `rejection_status`, `maker_id`, `maker_date`, `author_id`, `author_date`, `status`, `brnch_id`, `comp_id`, `zone_id`, `brnh_id`, `divn_id`) VALUES
(1, '1', '15', '001', '', '2017-04-28', '1', '800', '0', '2', '17', '21', '2', '0', '1600', 'Defleshing', 'Rejection Not Done', '1', '2017-04-28', NULL, NULL, 'A', NULL, '1', '1', '1', '1'),
(2, '1', '15', '001', '', '2017-04-28', '1', '200', '0', '', '', '16', '2', '0', '400', 'Defleshing', 'Rejection Not Done', '1', '2017-04-28', NULL, NULL, 'A', NULL, '1', '1', '1', '1'),
(3, '2', '15', '002', '', '2017-04-28', '1', '1', '0', '2', '17,19', '16', '32', '0', '2', 'Defleshing', 'Rejection Not Done', '1', '2017-04-28', NULL, NULL, 'A', NULL, '1', '1', '1', '1'),
(4, '2', '15', '002', '', '2017-04-28', '2', '200', '0', '', '17,19', '21', '2', '0', '400', 'Defleshing', 'Rejection Not Done', '1', '2017-04-28', NULL, NULL, 'A', NULL, '1', '1', '1', '1');
...
(2, '008', 'BOM', '1', '2017-04-21', '1', '2017-04-21', 'A', '1', '1', '1', '1'),
(4, '009', 'store keeper', '1', '2017-04-21', '1', '2017-04-21', 'A', '1', '1', '1', '1'),
(5, '0010', 'QA', '1', '2017-04-21', '1', '2017-04-21', 'A', '1', '1', '1', '1');
...
INSERT INTO `tbl_invoice_payment` (`id`, `contact_id`, `invoiceid`, `receive_billing_mount`, `remarks`, `date`, `maker_id`, `maker_date`, `comp_id`, `status`) VALUES
(1, '10', '1', '304.00', '', '2017-03-21 12:21:38', '1', '17-03-21', '1', 'invoice'),
(2, '10', '', '12', '', '2017-03-21', '1', '2017-03-21 16:54:35', '1', 'payment'),
(3, '10', '2', '152.00', '', '2017-03-22 13:48:52', '1', '17-03-22', '1', 'invoice');
...
CREATE TABLE `tbl_machine` (
  ...
  `machinecode` varchar(200) DEFAULT NULL,
  `machinename` varchar(200) NOT NULL,
  `hours` varchar(200) NOT NULL,
  `shift` varchar(200) NOT NULL,
  `supervisor` varchar(200) DEFAULT NULL,
  `operator_one` varchar(200) DEFAULT NULL,
  `operator_two` varchar(200) DEFAULT NULL,
  `shift_two` varchar(200) DEFAULT NULL,
  `supervisor_shift_two` varchar(200) DEFAULT NULL,
  `operator_one_shift_two` varchar(200) DEFAULT NULL,
  `operatortwo_shift_two` varchar(200) DEFAULT NULL,
  `machinedes` varchar(200) NOT NULL,
  `maker_id` varchar(200) DEFAULT NULL,
  `maker_date` date DEFAULT NULL,
  `author_id` varchar(200) DEFAULT NULL,
  `author_date` date DEFAULT NULL,
...
INSERT INTO `tbl_machine` (`Machine_id`, `machinecode`, `machinename`, `hours`, `shift`, `supervisor`, `operator_one`, `operator_two`, `shift_two`, `supervisor_shift_two`, `operator_one_shift_two`, `operatortwo_shift_two`, `machinedes`, `maker_id`, `maker_date`, `author_id`, `author_date`, `comp_id`, `zone_id`, `brnh_id`, `divn_id`, `status`) VALUES
(1, '001', 'Machine-1', '7', '1', 'we', 'a', 'as', '2', 'sd', 'dd', 'ddd', 's', NULL, '2017-04-14', NULL, '2017-04-14', '1', '1', '1', '1', 'A'),
(2, '1', '60 TON', '24', '1', 'RAMESH', 'MITHLESH', 'SAWANT', '2', 'RAMESH', 'MITHLESH', 'SAWANT', '', NULL, '2017-04-21', NULL, '2017-04-21', '1', '1', '1', '1', 'A'),
(3, '008', '80 TON', '2', '0', '0', '0', '0', '0', '0', '0', '0', '', NULL, '2017-04-25', NULL, '2017-04-25', '1', '1', '1', '1', 'A'),
(4, '1', 'FERROMATIC', '680', '0', '0', '0', '0', '0', '0', '0', '0', '620', NULL, '2017-04-26', NULL, '2017-04-26', '1', '1', '1', '1', 'A');
...
(13, '16', NULL, NULL, 'KG', '', '1', '2017-04-27 00:00:00', '1', '2017-04-27 00:00:00', 'A', '1', '1', '1', '1'),
(14, '16', NULL, NULL, 'Piece ', '', '1', '2017-04-24 00:00:00', '1', '2017-04-24 00:00:00', 'A', '1', '1', '1', '1');
...
(291, 'production/manage_template', 'Manage Template', 'h', NULL, NULL, NULL, NULL, 'A', '', NULL, NULL, NULL, NULL, NULL),
(295, 'Template/manageTamplate', 'Manage Tamplate', '33', NULL, NULL, NULL, NULL, 'A', '', NULL, NULL, NULL, NULL, NULL),
(296, 'master/Machine/manage_machine', 'Manage Machine', '3', NULL, NULL, NULL, NULL, 'A', '', NULL, NULL, NULL, NULL, NULL),
(297, 'production/manage_production', 'Manage Moulding', '26', NULL, NULL, NULL, NULL, 'A', '', NULL, NULL, NULL, NULL, NULL),
(299, 'BillOfMaterial/BillOfMaterial/manageBillMaterial', 'Manage Production Planning', '34', NULL, NULL, NULL, NULL, 'A', '', NULL, NULL, NULL, NULL, NULL),
(300, 'QA/manage_production', 'Manage QA', '35', NULL, NULL, NULL, NULL, 'A', '', NULL, NULL, NULL, NULL, NULL),
(301, 'defleshing/manage_defleshing', 'Manage Defleshing', '36', NULL, NULL, NULL, NULL, 'A', '', NULL, NULL, NULL, NULL, NULL),
(305, 'packing/manage_packing', 'Manage Packing', '39', NULL, NULL, NULL, NULL, 'A', '', NULL, NULL, NULL, NULL, NULL);
...
(25, 'Report', 8, 'A', '#', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(26, 'Moulding', 4, 'A', '#', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(36, 'Defleshing', 5, 'A', '#', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(33, 'Template', 3, 'A', '#', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(34, 'Production Planning', 3, 'A', '#', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(35, 'QA', 6, 'A', '#', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(39, 'Pack', 7, 'A', '#', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
(165, 121, 'Category', '', '', '', 'A', '1', '1', '2017-03-30', '2017-03-30', '1', '1', '1', '1');
...
INSERT INTO `tbl_production_log` (`wip_log_id`, `bom_id`, `p_id`, `lot_no`, `machine_id`, `date`, `shift`, `quantity`, `scrap`, `rejection_qty`, `operator`, `supervisor`, `hours`, `lumbs`, `act_hour`, `stage`, `rejection_status`, `maker_id`, `maker_date`, `author_id`, `author_date`, `status`, `brnch_id`, `comp_id`, `zone_id`, `brnh_id`, `divn_id`) VALUES
(1, '5', '15', '001', '4', '2017-04-28', '1', '900', '9', '2', '17', '21', '2', '0.002', '30', 'Moulding', 'Rejection Not Done', '1', '2017-04-28', NULL, NULL, 'A', NULL, '1', '1', '1', '1'),
(2, '1', '15', '001', '', '2017-04-28', '1', '800', '0', '2', '17', '21', '2', '0', '1600', 'Defleshing', 'Rejection Not Done', '1', '2017-04-28', NULL, NULL, 'A', NULL, '1', '1', '1', '1'),
(3, '5', '15', '001', '4', '2017-04-28', '1', '102', '1.02', '', '17', '21', '2', '0.002', '3.4', 'Moulding', 'Rejection Not Done', '1', '2017-04-28', NULL, NULL, 'A', NULL, '1', '1', '1', '1'),
(4, '1', '15', '001', '', '2017-04-28', '1', '200', '0', '', '', '16', '2', '0', '400', 'Defleshing', 'Rejection Not Done', '1', '2017-04-28', NULL, NULL, 'A', NULL, '1', '1', '1', '1'),
(5, '6', '15', '002', '4', '2017-04-28', '1', '400', '2', '2', '17', '21', '2', '0.002', '13.33', 'Moulding', 'Rejection Not Done', '1', '2017-04-28', NULL, NULL, 'A', NULL, '1', '1', '1', '1'),
(6, '6', '15', '002', '4', '2017-04-28', '1', '100', '0.5', '2', '17,19', '21', '2', '0.002', '3.33', 'Moulding', 'Rejection Not Done', '1', '2017-04-28', NULL, NULL, 'A', NULL, '1', '1', '1', '1'),
(7, '6', '15', '002', '3', '2017-04-28', '1', '1', '0.005', '2', '17,20', '18', '26', '0.001', '0.03', 'Moulding', 'Rejection Not Done', '1', '2017-04-28', NULL, NULL, 'A', NULL, '1', '1', '1', '1'),
(8, '2', '15', '002', '', '2017-04-28', '1', '1', '0', '2', '17,19', '16', '32', '0', '2', 'Defleshing', 'Rejection Not Done', '1', '2017-04-28', NULL, NULL, 'A', NULL, '1', '1', '1', '1'),
(9, '2', '15', '002', '', '2017-04-28', '2', '200', '0', '', '17,19', '21', '2', '0', '400', 'Defleshing', 'Rejection Not Done', '1', '2017-04-28', NULL, NULL, 'A', NULL, '1', '1', '1', '1'),
(10, '6', '15', '002', '4', '2017-04-28', '1', '5', '0.025', '', '', '16', '2', '0.002', '0.17', 'Moulding', 'Rejection Not Done', '1', '2017-04-28', NULL, NULL, 'A', NULL, '1', '1', '1', '1'),
(11, '7', '15', '005', '1', '2017-04-28', '1', '900', '8.1', '2', '17', '21', '2', '0.002', '30', 'Moulding', 'Rejection Not Done', '1', '2017-04-28', NULL, NULL, 'A', NULL, '1', '1', '1', '1'),
(12, '7', '15', '005', '4', '2017-04-28', '1', '2', '0.018', '', '19,20', '16', '2', '0.002', '0.07', 'Moulding', 'Rejection Not Done', '1', '2017-04-28', NULL, NULL, 'A', NULL, '1', '1', '1', '1');
...
CREATE TABLE `tbl_product_stock` (
  ...
  `cycle_time` varchar(200) NOT NULL,
...
INSERT INTO `tbl_product_stock` (`Product_id`, `sku_no`, `qtyinstock`, `quantity`, `style_no`, `productctg_id`, `Product_typeid`, `templateid`, `manufacturer_id`, `productname`, `category`, `under_group`, `serialno`, `unitprice_purchase`, `unitprice_sale`, `usageunit`, `pic_per_box`, `cycle_time`, `mrp`, `product_image`, `maker_id`, `maker_date`, `author_id`, `author_date`, `type`, `comp_id`, `zone_id`, `brnh_id`, `divn_id`, `color`, `size`, `status`) VALUES
(1, '1', '', '-52', '0', NULL, 'finish_goods', '0', NULL, 'HTC', '165', '', NULL, '1200', '1300', '13', '0', '', '', NULL, NULL, '2017-04-17', NULL, '2017-04-17', NULL, '1', '1', '1', '1', NULL, NULL, 'A'),
(2, '2', '', '-59', '0', NULL, 'finish_goods', '0', NULL, 'MI', '165', '', NULL, '1300', '1400', '13', '0', '', '', NULL, NULL, '2017-04-17', NULL, '2017-04-17', NULL, '1', '1', '1', '1', NULL, NULL, 'A'),
(5, '5', '', '', '0', NULL, 'row_material', '0', NULL, 'MAYK', '165', '', NULL, '400', '500', '13', '0', '', '', NULL, NULL, '2017-04-17', NULL, '2017-04-17', NULL, '1', '1', '1', '1', NULL, NULL, 'A'),
(8, '8', '', '', '0', NULL, 'finish_goods', '0', NULL, 'W10852321', '165', '', NULL, '32.55', '42.50', '14', '0', '', '', NULL, NULL, '2017-04-24', NULL, '2017-04-24', NULL, '1', '1', '1', '1', NULL, NULL, 'A'),
(9, '9', '', '', '0', NULL, 'row_material', '0', NULL, 'RMNYLON66', '165', '', NULL, '210', '210', '13', '0', '', '', NULL, NULL, '2017-04-21', NULL, '2017-04-21', NULL, '1', '1', '1', '1', NULL, NULL, 'A'),
(10, '10', '', '', '0', NULL, 'row_material', '0', NULL, 'RMABSRM120', '165', '', NULL, '145', '145', '13', '0', '', '', NULL, NULL, '2017-04-21', NULL, '2017-04-21', NULL, '1', '1', '1', '1', NULL, NULL, 'A'),
(12, '12', '', '', '0', NULL, 'finish_goods', '0', NULL, 'Body 6', '165', '', NULL, '', '', '14', '0', '85', '', NULL, NULL, '2017-04-27', NULL, '2017-04-27', NULL, '1', '1', '1', '1', NULL, NULL, 'A'),
(13, '13', '', '', '0', NULL, 'row_material', '0', NULL, 'PP 20 per GF BK GRADE P0204C3', '165', '', NULL, '', '', '13', '0', '', '', NULL, NULL, '2017-04-28', NULL, '2017-04-28', NULL, '1', '1', '1', '1', NULL, NULL, 'A'),
(14, '14', '', '', '0', NULL, 'row_material', '0', NULL, 'PP 20 per FG BK GRADE POLY', '165', '', NULL, '', '', '13', '0', '85', '', NULL, NULL, '2017-04-28', NULL, '2017-04-28', NULL, '1', '1', '1', '1', NULL, NULL, 'A'),
(15, '15', '', '', '0', NULL, 'finish_goods', '1', NULL, '7 BODY', '165', '', NULL, '', '', '14', '0', '120', '', NULL, NULL, '2017-04-27', NULL, '2017-04-27', NULL, '1', '1', '1', '1', NULL, NULL, 'A');
...
INSERT INTO `tbl_purchase_order_dtl` (`purchase_order_dtl_id`, `agent_id`, `product_id`, `list_price`, `quantity`, `unit`, `total`, `net_price`, `sub_total`, `service_charge_percentage`, `service_charge`, `gross_discount_percentage`, `gross_discount`, `grand_total`, `purchase_order_hdr_id`, `maker_id`, `maker_date`, `author_id`, `author_date`, `status`, `comp_id`, `zone_id`, `brnh_id`, `divn_id`) VALUES
(1, '11', '3', '5635', '1', '5', '5635', '5635', '6956', '', '0.00', '', '0', '6956.00', '1', '1', NULL, NULL, NULL, 'A', '1', '1', '1', NULL),
(2, '11', '2', '1321', '1', '12', '1321', '1321', '6956', '', '0.00', '', '0', '6956.00', '1', '1', NULL, NULL, NULL, 'A', '1', '1', '1', NULL),
(3, '11', '1', '54564', '1', '5', '54564', '54564', '60199', '', '0.00', '', '0', '60199.00', '2', '1', NULL, NULL, NULL, 'A', '1', '1', '1', NULL),
(4, '11', '3', '5635', '1', '5', '5635', '5635', '60199', '', '0.00', '', '0', '60199.00', '2', '1', NULL, NULL, NULL, 'A', '1', '1', '1', NULL),
(5, '11', '4', '2', '1', '5', '2', '2', '32', '', '0.00', '', '0', '32.00', '3', '1', NULL, NULL, NULL, 'A', '1', '1', '1', NULL),
(6, '11', '5', '30', '1', '5', '30', '30', '32', '', '0.00', '', '0', '32.00', '3', '1', NULL, NULL, NULL, 'A', '1', '1', '1', NULL),
(7, '11', '6', '8', '1', '', '8', '8', '8', '', '0.00', '', '0', '8.00', '4', '1', NULL, NULL, NULL, 'A', '1', '1', '1', NULL),
(8, '11', '1', '234', '1', '5', '234', '234', '234', '', '0.00', '', '0', '234.00', '5', '1', NULL, NULL, NULL, 'A', '1', '1', '1', NULL);
...
INSERT INTO `tbl_purchase_order_hdr` (`purchase_order_id`, `vendor_id`, `delivery_date`, `agent_id`, `sub_total`, `service_charge`, `service_charge_percentage`, `gross_discount`, `gross_discount_percentage`, `grand_total`, `maker_id`, `maker_date`, `author_id`, `author_date`, `status`, `comp_id`, `zone_id`, `brnh_id`, `divn_id`) VALUES
(1, '8', '2017-03-20', '11', '6956', '0.00', '', '0', '', '6956.00', '1', '2017-03-20', NULL, NULL, 'A', '1', '1', '1', '1'),
(2, '8', '2017-03-20', '11', '60199', '0.00', '', '0', '', '60199.00', '1', '2017-03-20', NULL, NULL, 'A', '1', '1', '1', '1'),
(3, '8', '2017-03-21', '11', '32', '0.00', '', '0', '', '32.00', '1', '2017-03-21', NULL, NULL, 'A', '1', '1', '1', '1'),
(4, '8', '2017-03-21', '11', '8', '0.00', '', '0', '', '8.00', '1', '2017-03-21', NULL, NULL, 'A', '1', '1', '1', '1'),
(5, '8', '2017-03-21', '11', '234', '0.00', '', '0', '', '234.00', '1', '2017-03-21', NULL, NULL, 'A', '1', '1', '1', '1');
...
--
-- Table structure for table `tbl_qa_hdr`
--

CREATE TABLE `tbl_qa_hdr` (
  `wip_hdr_id` int(200) NOT NULL,
  `product_type` varchar(200) NOT NULL,
  `product_name` varchar(200) NOT NULL,
  `date` varchar(200) NOT NULL,
...
--
-- Table structure for table `tbl_qa_log`
--

CREATE TABLE `tbl_qa_log` (
  `wip_log_id` int(200) NOT NULL,
  `bom_id` varchar(200) NOT NULL,
  `p_id` varchar(200) NOT NULL,
  `lot_no` varchar(200) NOT NULL,
...
(1, '1', '4', '91', 'Active', '1', '2017-03-18', '1', '2017-03-18', 'A', '1', '1', '1', '1'),
(2, '1', '4', '111', 'Active', '1', '2017-03-18', '1', '2017-03-18', 'A', '1', '1', '1', '1'),
(3, '1', '4', '93', 'Active', NULL, NULL, NULL, NULL, 'A', NULL, NULL, NULL, NULL),
(4, '1', '4', '95', 'Active', NULL, NULL, NULL, NULL, 'A', NULL, NULL, NULL, NULL),
(5, '1', '4', '97', 'Active', NULL, NULL, NULL, NULL, 'A', NULL, NULL, NULL, NULL),
(6, '1', '4', '99', 'Active', NULL, NULL, NULL, NULL, 'A', NULL, NULL, NULL, NULL),
(7, '1', '4', '101', 'Active', NULL, NULL, NULL, NULL, 'A', NULL, NULL, NULL, NULL),
(8, '1', '4', '103', 'Active', NULL, NULL, NULL, NULL, 'A', NULL, NULL, NULL, NULL),
(9, '1', '4', '105', 'Active', NULL, NULL, NULL, NULL, 'A', NULL, NULL, NULL, NULL),
(10, '1', '4', '107', 'Active', NULL, NULL, NULL, NULL, 'A', NULL, NULL, NULL, NULL),
(11, '1', '4', '109', 'Active', NULL, NULL, NULL, NULL, 'A', NULL, NULL, NULL, NULL),
(12, '1', '4', '113', 'Active', NULL, NULL, NULL, NULL, 'A', NULL, NULL, NULL, NULL),
(13, '1', '4', '115', 'Active', NULL, NULL, NULL, NULL, 'A', NULL, NULL, NULL, NULL),
(14, '1', '4', '117', 'Active', NULL, NULL, NULL, NULL, 'A', NULL, NULL, NULL, NULL),
(15, '1', '4', '166', 'Active', NULL, NULL, NULL, NULL, 'A', NULL, NULL, NULL, NULL),
(16, '1', '4', '167', 'Active', NULL, NULL, NULL, NULL, 'A', NULL, NULL, NULL, NULL),
(17, '1', '4', '189', 'Active', NULL, NULL, NULL, NULL, 'A', NULL, NULL, NULL, NULL),
...
(38, '1', '26', '291', 'Active', NULL, NULL, NULL, NULL, 'A', NULL, NULL, NULL, NULL),
(39, '1', '26', '292', 'Active', NULL, NULL, NULL, NULL, 'A', NULL, NULL, NULL, NULL),
(40, '1', '33', '295', 'Active', NULL, NULL, NULL, NULL, 'A', NULL, NULL, NULL, NULL),
(41, '1', '3', '296', 'Active', NULL, NULL, NULL, NULL, 'A', NULL, NULL, NULL, NULL),
(42, '1', '26', '297', 'Active', NULL, NULL, NULL, NULL, 'A', NULL, NULL, NULL, NULL),
(43, '1', '26', '298', 'Active', NULL, NULL, NULL, NULL, 'A', NULL, NULL, NULL, NULL),
(44, '1', '34', '299', 'Active', NULL, NULL, NULL, NULL, 'A', NULL, NULL, NULL, NULL),
(45, '1', '35', '300', 'Active', NULL, NULL, NULL, NULL, 'A', NULL, NULL, NULL, NULL),
(46, '2', '34', '299', 'Active', NULL, NULL, NULL, NULL, 'A', NULL, NULL, NULL, NULL),
(47, '4', '35', '300', 'Active', NULL, NULL, NULL, NULL, 'A', NULL, NULL, NULL, NULL),
(48, '5', '26', '297', 'Active', NULL, NULL, NULL, NULL, 'A', NULL, NULL, NULL, NULL),
(49, '1', '36', '301', 'Active', NULL, NULL, NULL, NULL, 'A', NULL, NULL, NULL, NULL);
...
(2, '0091', 'BOM', '1', '2017-04-21', '1', '2017-04-21', 'A', '1', '1', '1', '1', 'edit-view-delete-Add'),
(3, '0092', 'store keeper', '1', '2017-04-21', '1', '2017-04-21', 'A', '1', '1', '1', '1', 'edit-view-delete-Add'),
(4, '0092', 'AQ', '1', '2017-04-21', '1', '2017-04-21', 'A', '1', '1', '1', '1', 'edit-view-delete-Add'),
(5, 'WIP', 'WIP', '1', '2017-04-21', '1', '2017-04-21', 'A', '1', '1', '1', '1', 'edit-view-delete-Add');
...
INSERT INTO `tbl_sales_order_dtl` (`sales_dtl_id`, `agent_id`, `product_id`, `salesid`, `list_price`, `quantity`, `unit`, `total`, `net_price`, `sub_total`, `service_charge_percentage`, `service_charge`, `gross_discount_percentage`, `gross_discount`, `grand_total`, `maker_id`, `maker_date`, `author_id`, `author_date`, `status`, `comp_id`, `zone_id`, `brnh_id`, `divn_id`) VALUES
(2, '', '1', '1', '152', '1', '5', '152', '152', '304', '', '0.00', '', '0', '304.00', '1', NULL, NULL, NULL, 'A', '1', '1', '1', NULL),
(3, '', '1', '1', '152', '1', '5', '152', '152', '304', '', '0.00', '', '0', '304.00', '1', NULL, NULL, NULL, 'A', '1', '1', '1', NULL),
(4, '', '1', '2', '152', '1', '5', '152', '152', '152', '', '0.00', '', '0', '152.00', '1', NULL, NULL, NULL, 'A', '1', '1', '1', NULL);
...
INSERT INTO `tbl_sales_order_hdr` (`salesid`, `vendor_id`, `delivery_date`, `agent_id`, `sub_total`, `service_charge`, `service_charge_percentage`, `gross_discount`, `gross_discount_percentage`, `grand_total`, `maker_id`, `maker_date`, `author_id`, `author_date`, `status`, `comp_id`, `zone_id`, `brnh_id`, `divn_id`) VALUES
(1, '10', '2017-03-21', '', '304', '0.00', '', '0', '', '304.00', '1', '2017-03-21', '', '0000-00-00', 'A', '1', '1', '1', '1'),
(2, '10', '2017-03-22', '', '152', '0.00', '', '0', '', '152.00', '1', '2017-03-22', '', '0000-00-00', 'A', '1', '1', '1', '1');
...
CREATE TABLE `tbl_template_dtl` (
  `template_dtl_id` int(200) NOT NULL,
  `item_name` varchar(200) NOT NULL,
  `product_name` varchar(200) NOT NULL,
  `quentity` varchar(200) NOT NULL,
  `unit` varchar(200) NOT NULL,
  ...
  `net_weight` varchar(200) NOT NULL,
  `scrap_weight` varchar(200) NOT NULL,
  `template_hdr_id` varchar(200) NOT NULL,
  `sub_total` varchar(200) NOT NULL,
  `service_charge_percentage` varchar(200) DEFAULT NULL,
  `service_charge` varchar(200) DEFAULT NULL,
  `gross_discount_percentage` varchar(200) DEFAULT NULL,
...
INSERT INTO `tbl_template_dtl` (`template_dtl_id`, `item_name`, `product_name`, `quentity`, `unit`, `gross_weight`, `net_weight`, `scrap_weight`, `template_hdr_id`, `sub_total`, `service_charge_percentage`, `service_charge`, `gross_discount_percentage`, `gross_discount`, `grand_total`, `maker_id`, `maker_date`, `author_id`, `author_date`, `status`, `comp_id`, `zone_id`, `brnh_id`, `divn_id`) VALUES
(9, '13', '15', '1', 'KG', '0.17', '0.17', '0.01', '5', '0.01', '', '0.00', '', '0', '0.01', '1', '0000-00-00', NULL, '2017-04-28', 'A', '1', '1', '1', NULL),
(10, '14', '15', '1', 'KG', '0.11', '0.11', '0', '5', '0.01', '', '0.00', '', '0', '0.01', '1', '0000-00-00', NULL, '2017-04-28', 'A', '1', '1', '1', NULL);
...
CREATE TABLE `tbl_template_hdr` (
  `template_hdr_id` int(200) NOT NULL,
  `product_code` varchar(200) DEFAULT NULL,
  `product_name` varchar(200) NOT NULL,
  `maker_id` varchar(200) DEFAULT NULL,
  `maker_date` date DEFAULT NULL,
...
INSERT INTO `tbl_template_hdr` (`template_hdr_id`, `product_code`, `product_name`, `maker_id`, `maker_date`, `author_id`, `author_date`, `status`, `comp_id`, `zone_id`, `brnh_id`, `divn_id`) VALUES
(5, '', '15', '1', '2017-04-28', NULL, '2017-04-28', 'A', '1', '1', '1', '1');
...
(2, 'safi', '12345', '', '2', '', '1', '1', '1', '2017-04-21', '1', '2017-04-21', 'A', 'self', 1, '1', '1', '1', '1', '', 'bablu.kkhan@gmail.co', '9716127292'),
(3, 'ravi', '12345', '', '4', '', '1', '1', '1', '2017-04-21', '1', '2017-04-21', 'A', 'self', 1, '1', '1', '1', '1', '', 'ravi@gmail.com', '9716127292'),
(4, 'gaurav', '12345', '', '5', '', '1', '1', '1', '2017-04-21', '1', '2017-04-21', 'A', 'self', 1, '1', '1', '1', '1', '', 'collestbablu@gmail.c', '9716127292');
...
(4, '4', '4', '', '', '', '', NULL, NULL, NULL, NULL, 'A'),
(6, '3', '5', '', '', '', '', NULL, NULL, NULL, NULL, 'A');
...
--
-- Table structure for table `tbl_wip_dtl`
--

CREATE TABLE `tbl_wip_dtl` (
  `wip_dtl_id` int(200) NOT NULL,
  `product_name` varchar(200) NOT NULL,
  `lot_no` varchar(200) NOT NULL,
  `quentity` varchar(200) NOT NULL,
  `enter_quantity` varchar(200) NOT NULL,
  `unit` varchar(200) NOT NULL,
  `gross_weight` varchar(200) NOT NULL,
  `net_weight` varchar(200) NOT NULL,
  `scrap_weight` varchar(200) NOT NULL,
  `new_quantity` varchar(200) NOT NULL,
  `scrap` varchar(200) DEFAULT NULL,
  `completed` varchar(200) DEFAULT NULL,
  `not_completed` varchar(200) DEFAULT NULL,
  `wip_hdr_id` varchar(200) NOT NULL,
  `maker_id` varchar(200) DEFAULT NULL,
  `maker_date` date DEFAULT NULL,
  `author_id` varchar(200) DEFAULT NULL,
  `author_date` date DEFAULT NULL,
...
--
-- Table structure for table `tbl_wip_hdr`
--

CREATE TABLE `tbl_wip_hdr` (
  `wip_hdr_id` int(200) NOT NULL,
  `product_type` varchar(200) NOT NULL,
  `product_name` varchar(200) NOT NULL,
  `date` varchar(200) NOT NULL,
...
--
-- Dumping data for table `tbl_wip_hdr`
--

INSERT INTO `tbl_wip_hdr` (`wip_hdr_id`, `product_type`, `product_name`, `date`, `lot_no`, `scrap`, `hours`, `lumbs`, `act_hour`, `qty_made`, `rejection_qty`, `quantity`, `maker_id`, `maker_date`, `author_id`, `author_date`, `status`, `comp_id`, `zone_id`, `brnh_id`, `divn_id`) VALUES
(1, '', '15', '17-04-28', '001', '10.02', '4', '0.022', '33.4', '1000', '', '1000', '1', '2017-04-28', NULL, NULL, 'A', '1', '1', '1', '1'),
(2, '', '15', '17-04-28', '002', '2.53', '32', '0.052', '16.86', '500', '', '500', '1', '2017-04-28', NULL, NULL, 'A', '1', '1', '1', '1'),
(3, '', '15', '17-04-28', '005', '8.118', '4', '0.022', '30.07', '900', '', '900', '1', '2017-04-28', NULL, NULL, 'A', '1', '1', '1', '1');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_wip_log`
--

CREATE TABLE `tbl_wip_log` (
  `wip_log_id` int(200) NOT NULL,
  `bom_id` varchar(200) NOT NULL,
  `p_id` varchar(200) NOT NULL,
  `lot_no` varchar(200) NOT NULL,
...
--
-- Dumping data for table `tbl_wip_log`
--

INSERT INTO `tbl_wip_log` (`wip_log_id`, `bom_id`, `p_id`, `lot_no`, `machine_id`, `date`, `shift`, `quantity`, `scrap`, `rejection_qty`, `operator`, `supervisor`, `hours`, `lumbs`, `act_hour`, `stage`, `rejection_status`, `maker_id`, `maker_date`, `author_id`, `author_date`, `status`, `brnch_id`, `comp_id`, `zone_id`, `brnh_id`, `divn_id`) VALUES
(1, '5', '15', '001', '4', '2017-04-28', '1', '900', '9', '2', '17', '21', '2', '0.002', '30', 'Moulding', 'Rejection Not Done', '1', '2017-04-28', NULL, NULL, 'A', NULL, '1', '1', '1', '1'),
(2, '5', '15', '001', '4', '2017-04-28', '1', '102', '1.02', '', '17', '21', '2', '0.002', '3.4', 'Moulding', 'Rejection Not Done', '1', '2017-04-28', NULL, NULL, 'A', NULL, '1', '1', '1', '1'),
(3, '6', '15', '002', '4', '2017-04-28', '1', '400', '2', '2', '17', '21', '2', '0.002', '13.33', 'Moulding', 'Rejection Not Done', '1', '2017-04-28', NULL, NULL, 'A', NULL, '1', '1', '1', '1'),
(4, '6', '15', '002', '4', '2017-04-28', '1', '100', '0.5', '2', '17,19', '21', '2', '0.002', '3.33', 'Moulding', 'Rejection Not Done', '1', '2017-04-28', NULL, NULL, 'A', NULL, '1', '1', '1', '1'),
(5, '6', '15', '002', '3', '2017-04-28', '1', '1', '0.005', '2', '17,20', '18', '26', '0.001', '0.03', 'Moulding', 'Rejection Not Done', '1', '2017-04-28', NULL, NULL, 'A', NULL, '1', '1', '1', '1'),
(6, '6', '15', '002', '4', '2017-04-28', '1', '5', '0.025', '', '17', '16', '2', '0.002', '0.17', 'Moulding', 'Rejection Not Done', '1', '2017-04-28', NULL, NULL, 'A', NULL, '1', '1', '1', '1'),
(7, '7', '15', '005', '1', '2017-04-28', '1', '900', '8.1', '2', '17', '21', '2', '0.002', '30', 'Moulding', 'Rejection Not Done', '1', '2017-04-28', NULL, NULL, 'A', NULL, '1', '1', '1', '1'),
(8, '7', '15', '005', '4', '2017-04-28', '1', '2', '0.018', '', '19,20', '16', '2', '0.002', '0.07', 'Moulding', 'Rejection Not Done', '1', '2017-04-28', NULL, NULL, 'A', NULL, '1', '1', '1', '1');
...
--
-- Indexes for table `tbl_bill_of_material_dtl`
--
ALTER TABLE `tbl_bill_of_material_dtl`
  ADD PRIMARY KEY (`bill_of_material_dtl_id`);

--
-- Indexes for table `tbl_bill_of_material_hdr`
--
ALTER TABLE `tbl_bill_of_material_hdr`
  ADD PRIMARY KEY (`bill_of_material_id_hdr`);
...
--
-- Indexes for table `tbl_defleshing_hdr`
--
ALTER TABLE `tbl_defleshing_hdr`
  ADD PRIMARY KEY (`wip_hdr_id`);

--
-- Indexes for table `tbl_defleshing_log`
--
ALTER TABLE `tbl_defleshing_log`
  ADD PRIMARY KEY (`wip_log_id`);
...
--
-- Indexes for table `tbl_qa_hdr`
--
ALTER TABLE `tbl_qa_hdr`
  ADD PRIMARY KEY (`wip_hdr_id`);

--
-- Indexes for table `tbl_qa_log`
--
ALTER TABLE `tbl_qa_log`
  ADD PRIMARY KEY (`wip_log_id`);
...
ALTER TABLE `tbl_template_dtl`
  ADD PRIMARY KEY (`template_dtl_id`);

--
-- Indexes for table `tbl_template_hdr`
--
ALTER TABLE `tbl_template_hdr`
  ADD PRIMARY KEY (`template_hdr_id`);
...
--
-- Indexes for table `tbl_wip_dtl`
--
ALTER TABLE `tbl_wip_dtl`
  ADD PRIMARY KEY (`wip_dtl_id`);

--
-- Indexes for table `tbl_wip_hdr`
--
ALTER TABLE `tbl_wip_hdr`
  ADD PRIMARY KEY (`wip_hdr_id`);

--
-- Indexes for table `tbl_wip_log`
--
ALTER TABLE `tbl_wip_log`
  ADD PRIMARY KEY (`wip_log_id`);
...
--
-- AUTO_INCREMENT for table `tbl_bill_of_material_dtl`
--
ALTER TABLE `tbl_bill_of_material_dtl`
  MODIFY `bill_of_material_dtl_id` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `tbl_bill_of_material_hdr`
--
ALTER TABLE `tbl_bill_of_material_hdr`
  MODIFY `bill_of_material_id_hdr` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
...
--
-- AUTO_INCREMENT for table `tbl_defleshing_hdr`
--
ALTER TABLE `tbl_defleshing_hdr`
  MODIFY `wip_hdr_id` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `tbl_defleshing_log`
--
ALTER TABLE `tbl_defleshing_log`
  MODIFY `wip_log_id` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `tbl_enterprise_mst`
--
ALTER TABLE `tbl_enterprise_mst`
  MODIFY `comp_id` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `tbl_module_function`
  MODIFY `func_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=306;
--
...
--
ALTER TABLE `tbl_prodcatg_mst`
  MODIFY `prodcatg_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=166;
--
-- AUTO_INCREMENT for table `tbl_production_log`
--
ALTER TABLE `tbl_production_log`
  MODIFY `wip_log_id` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
...
--
ALTER TABLE `tbl_proforma_invoice_dtl`
  MODIFY `proforma_invoice_dtl_id` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `tbl_proforma_invoice_hdr`
--
ALTER TABLE `tbl_proforma_invoice_hdr`
  MODIFY `proforma_invoice_id` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `tbl_purchase_order_dtl`
--
ALTER TABLE `tbl_purchase_order_dtl`
  MODIFY `purchase_order_dtl_id` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `tbl_purchase_order_hdr`
--
ALTER TABLE `tbl_purchase_order_hdr`
  MODIFY `purchase_order_id` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
...
--
-- AUTO_INCREMENT for table `tbl_qa_hdr`
--
ALTER TABLE `tbl_qa_hdr`
  MODIFY `wip_hdr_id` int(200) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tbl_qa_log`
--
ALTER TABLE `tbl_qa_log`
  MODIFY `wip_log_id` int(200) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `tbl_role_func_action`
  MODIFY `rol_func_act_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
--
-- AUTO_INCREMENT for table `tbl_role_mst`
--
ALTER TABLE `tbl_role_mst`
  MODIFY `role_id` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `tbl_sales_order_dtl`
--
ALTER TABLE `tbl_sales_order_dtl`
  MODIFY `sales_dtl_id` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `tbl_sales_order_hdr`
--
ALTER TABLE `tbl_sales_order_hdr`
  MODIFY `salesid` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `tbl_template_dtl`
  MODIFY `template_dtl_id` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `tbl_template_hdr`
--
ALTER TABLE `tbl_template_hdr`
  MODIFY `template_hdr_id` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `tbl_user_role_mst`
  MODIFY `user_role_id` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
...
--
-- AUTO_INCREMENT for table `tbl_wip_dtl`
--
ALTER TABLE `tbl_wip_dtl`
  MODIFY `wip_dtl_id` int(200) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tbl_wip_hdr`
--
ALTER TABLE `tbl_wip_hdr`
  MODIFY `wip_hdr_id` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `tbl_wip_log`
--
ALTER TABLE `tbl_wip_log`
  MODIFY `wip_log_id` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
