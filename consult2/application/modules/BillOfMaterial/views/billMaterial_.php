...
<div>
		...
		<table class="bordered">
			  ...
			  <option value="finish_goods"<?php  if($row->Product_typeid=='semi_finish_goods'){ ?> selected <?php } ?>>Semi Finish Goods</option>
					...
					<th><input type="text" name="product_code" id="product_code" placeholder="Product Code" style="width:80px;" onKeyUp="filterProductCode()"></th>					
			...
			<tr>
					...
					<th><input type="date" required name="date_name" value="<?php echo $detail->date;?>"  style="  min-width: 80%;"/></th>
