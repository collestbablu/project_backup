<?php
class model_admin_login_1 extends CI_Model {
	...
	public function insert_user($table_name,$machine_id,$machine_date,$m_b_d_name,$hours){
	
	  $this->db->query("insert into $table_name set machine_id = ?,machine_date=?,m_b_d_name=?,hours=?",array($machine_id,$machine_date,$m_b_d_name,$hours));
