...
<thead>
<tr><th style="text-align:center;color:#fff" colspan="4">
<?php if(@$_GET['view']!=""){?>
<b>View Details</b>
<?php }
elseif(@$_GET['id']!=""){
...
<select name="maingroupname" tabindex="2" required id="contact_id_copy5" <?php if(@$_GET['view']!=''){ ?> disabled <?php }?>>
...
<td><input type="tel" name="mobile" required="true"  class="span6 "value="<?php if(@$_GET['id']!=''|| @$_GET['view']!=''){ echo $row->mobile;}?>" maxlength="12"  size="22"    tabindex="3" <?php if(@$_GET['view']!=""){
?> readonly <?php } ?>/></td>

<td class="text-r">Email ID:</td>

<td><input type="email" name="email" class="span6 "value="<?php if(@$_GET['id']!=''|| @$_GET['view']!=''){ echo $row->email;}?>"   size="22"    tabindex="4" <?php if(@$_GET['view']!=""){
?> readonly <?php } ?>/></td>
</tr>
<tr style="display:none">

<td class="text-r" >Phone:</td>
...
<td class="text-r"><star></star> <b style="display:none">Address2:</b></td>         


<td><textarea  name="address3" style="height:100px;display:none"  class="span6" <?php if(@$_GET['view']!=""){?> readonly <?php } ?> cols="10" rows="10" tabindex="18"><?php if(@$_GET['id']!='' || @$_GET['view']!=''){ echo $row->address3 ;} ?> 
</textarea></td></tr>
