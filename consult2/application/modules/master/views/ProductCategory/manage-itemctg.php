...
<div class="add">
<?php if($add!=''){ ?>
<?php ?><a href="add_itemctg?mid=121"><img src="<?php echo base_url();?>/assets/images/plus.png" alt="" border="0" /> Add</a>
<?php  } ?>
...
<table class="bordered"id="dataTables-example">
	...
	<tr>
      <td><input type="checkbox"></td>  
		...
		<td style="display:none"><input type="text" id="id4" onKeyUp="search_row(this.id,4)" class="input-small"></td>
		<td style="display:none"><input type="text" id="id5" onKeyUp="search_row(this.id,5)" class="input-small"></td>
        <td></td>
    </tr>
    </thead>
