...
$viewId = $this->input->get('edit');
?>

<h1> Update Breakdown Details</h1>

<form action="update_machine_breakdown" method="post" enctype="multipart/form-data">
...
<tr>
<td width="10%"><div style="width: 130px;"><input type="date" class="input-small" name="machine_date" id="itemdate" value="<?=$this->input->get('edit');?>"   required/></div></td>
...
<tr>
	...
	<?php for($m=0;$m<$i;$m++){ 
		...
		?>	
	<th><input type="text" class="input-small" name="hoursname[]" id="hours" value="<?php echo $convertArray[$m];?>"  /> </th>	
	<?php } ?>

</tr>
<?php $j++; } ?>
<input type="hidden" class="input-small" name="mb_date" id="mb_date" value="<?php echo $viewId;?>"  />
</tbody>
</table>
</div>
</div>
