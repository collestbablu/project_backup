...
<thead>
<tr>
<th colspan="4"><b>Search Supervisor Report </b></th>        
</tr>
</thead>
<tr>
...
<table class="bordered" id="dataTables-example">
    <thead>
  <tr>
<th>Lot No</th><th>Finish Goods</th><th>Unit</th><th>Machine Name</th><th>Total Qty</th><th>Completed Qty</th><th>Rejected Qty</th>
</tr>
    </thead>
	<?php
	  @extract($_GET);
...
if($Search=='')
	{
		$queryy="select * from tbl_production_log group by supervisor ";
		}
   ...
   if($i%2!=0){
	...
	<td><input type="text" name="totQty" readonly value="<?php echo $getMachine->machinename; ?>"></td>
