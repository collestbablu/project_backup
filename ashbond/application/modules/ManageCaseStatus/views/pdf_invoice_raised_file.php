...
<title>Invoice Raised List</title>
</head>

<body>
<h1><u>Invoice Raised List</u></h1> 
<table width="100%" border="1">
 ...
 <?php
		  ...
		  $queryy="select * from tbl_new_case where action_status='Invoice-Raised' order by new_case_id desc";
