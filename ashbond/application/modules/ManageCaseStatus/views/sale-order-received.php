<title>Sale Order Received List <?php date_default_timezone_set("Asia/Kolkata"); echo $date = date("d-m-Y");   ?></title>
<?php
$tableName='tbl_new_case';
$this->load->view('softwareheader'); 
?>

<h1>Sale Order Received List </h1> 
<div class="actions">
<div class="blogroll">
...
<div class="add">
<a href="download_pdf_file_sale_order_received"><img src="<?php echo base_url();?>/assets/images/download.png" alt="" border="0" />&nbsp;&nbsp;Pdf Download</a>
</div>
<!--add close-->
<div class="clear"></div>
</div><!--title close-->
...
<table class="bordered table-hover dataTables-example">
	...
	<?php
		  ...
		  $queryy="select * from $tableName where action_status='Sale-Order-Received' order by new_case_id desc";
