<title>Budgetary Offer Sent List <?php date_default_timezone_set("Asia/Kolkata"); echo $date = date("d-m-Y");   ?></title>
<?php
...
<div class="add">
<a href="save_download_pdf_file_completed"><img src="<?php echo base_url();?>/assets/images/download.png" alt="" border="0" />&nbsp;&nbsp;Pdf Download</a>
</div>
<!--add close-->
<div class="clear"></div>
</div><!--title close-->
...
<table class="bordered table-hover dataTables-example">
	...
	<?php
		  ...
		  $queryy="select * from tbl_new_case where action_status='Completed' order by new_case_id desc";
