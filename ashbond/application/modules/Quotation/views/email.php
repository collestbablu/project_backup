...
<td style="text-align:center"><strong><?php if($cntPartNo==0){?><?php echo  number_format( $invoiceFetch->grand_total,2, '.', ','); ?><?php } else {?>TOTAL<?php }?></strong></td>
<?php if($cntPartNo>0){?>
...
<table id="items-to" style="border:none !important;outline: none;">
