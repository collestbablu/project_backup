...
$getSO=$SOQuery->row();
?>
<form method="post" action="<?=base_url();?>Quotation/send_mail_functions">
<div id="container">
<div class="table-row">
<label>Cc</label>
<input type="text" name="ccemail" value="" />
<input type="text" name="id" value="<?php echo $_GET['id']?>" />
</div>
<center><label><input type="submit" name="send" value="Send" /></label></center>
</div>
