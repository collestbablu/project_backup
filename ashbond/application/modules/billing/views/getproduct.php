...
<input type="text" id="ty<?php echo $id;?>"  class="prds" value="<?php echo $arr->productname.'('.$fetchsize->keyvalue.')' ?>^<?php echo $arr->Product_id; ?>" name="<?php echo $id;?>"
 onFocus="abc(this.value,'<?php echo $arr->unitprice_sale; ?>',this.id,'<?php echo $qty; ?>','<?php echo $usunit; ?>')"
 onClick="abc(this.value,'<?php echo $arr->unitprice_sale; ?>',this.id,'<?php echo $qty; ?>','<?php echo $usunit; ?>')" style="width:100%;border:none;border-bottom:1px solid;border-left:1px solid;" tabindex="-1"  readonly >
...
// onClick="abc(this.value,'<?php echo $arr['unitprice_sale']; ?>',this.id,<?php echo $arr['qtyinstock']; ?>,<?php echo $arr['reorderlevelqty']; ?>)"<?php */
