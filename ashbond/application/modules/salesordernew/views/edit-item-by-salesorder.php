...
<body>
<h4>Edit Sales Order Item</h4>
<?php 
$idd=$_GET['view'];
$query_dtl=$this->db->query("select * from tbl_sales_ordernew_dtl where purchase_order_dtl_id='$idd'");
...
?>
<center>
<form method="post" action="editsalesorderitem">
