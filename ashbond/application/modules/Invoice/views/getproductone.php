...
<input type="text" name="refno"  value="AEPL/<?php echo $case; ?>/<?php echo $totalyear; ?>/<?php echo $dasaa; ?>/" readonly style="width: 50%;float: left;border: none;"/><input type="text" name="communication_name" style="width: 12%;margin: 0 0 0 10px; border: none;" id="commid" onkeyup="communication_fun()"  value="<?php echo $mkk; ?>" />
