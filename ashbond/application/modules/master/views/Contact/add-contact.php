...
<td style="display:none"><input type="text" name="account_id" class="span6 "value="<?php echo $branchFetch->contact_id;?>" readonly size="22" aria-required='true' /></td>
...
<td><input type="text" required name="primary_contact" value="<?php echo $branchFetch->first_name;?>"></td>
...
<td><input type="text" name="company_name" required class="span6" value="<?php  echo  $branchFetch->company_name; ?>" size="3"  min="1" max="100" <?php if(@$_GET['view']!=""){
?> readonly <?php } ?>/></td>

<td class="text-r"><star></star> Email ID:</td>

<td><input type="email" name="email" class="span6 "value="<?php echo $branchFetch->email; ?>"   size="22" <?php if(@$_GET['view']!=""){
?> readonly <?php } ?>/></td>
...
<td style="display:none"><input type="number"  name="phone" class="span6 "value="<?php echo $branchFetch->phone; ?>"  size="22" <?php if(@$_GET['view']!=""){
?> readonly <?php } ?>/></td>

<td class="text-r"><star></star>Mobile:</td>

<td><input type="number" name="mobile"  class="span6 "value="<?php echo $branchFetch->mobile; ?>" size="22" <?php if(@$_GET['view']!=""){
?> readonly <?php } ?>/></td>

<td class="text-r">IT Pan:</td>
<td><input type="text" name="it_pan" class="span6" value="<?php echo $branchFetch->IT_Pan;  ?>" size="3" min="1" max="100" <?php if(@$_GET['view']!=""){
?> readonly <?php } ?>/></td>
</tr>
<tr>
<td class="text-r" style="display:none">Ward</td>
<td style="display:none"><input type="text" name="ward" class="span6" value="<?php echo $branchFetch->ward; ?>" size="3" min="1" max="100" <?php if(@$_GET['view']!=""){
?> readonly <?php } ?>/></td>

<td class="text-r">GSTIN No:</td>
<td><input type="text" name="cst_no" id="cst_no" class="span6" value="<?php echo $branchFetch->cst; ?>" size="3" min="1" max="100" <?php if(@$_GET['view']!=""){
?> readonly <?php } ?>/></td>

<td class="text-r">Fax:</td>
<td><input type="text" name="fax" class="span6" value="<?php echo $branchFetch->fax; ?>" size="3" min="1" max="100" <?php if(@$_GET['view']!=""){
?> readonly <?php } ?>/></td>
</tr>
<tr>
<td class="text-r"><star>*</star>Code:</td> 
<td><input type="text" name="code_name" style="text-transform: uppercase; " required class="span6" value="<?php echo $branchFetch->code_name; ?>" size="3"  min="1" max="100" <?php if(@$_GET['view']!=""){
?> readonly <?php } ?>/></td>

<td class="text-r"><star>*</star>State:</td>
<td><select name="state_id" required>
<option value="">--Select--</option>
<?php
...
<th style="width: 39%;">Designation</th>
  ...
  <div class="button_pro" style="width:1000px;">
	<div class='space' id='input_1' style="width:94%;">
		<star>*</star>&nbsp;<input id="input_1" style="width:20%;" type="text" name="val[]" class='left txt' required />&nbsp;<input id="input_1" style="width:20%;" type="email" name="valemail[]" class='left txt'/>&nbsp;<input id="input_1" style="width:20%;" type="text" name="valmobile[]" class='left txt'/>&nbsp;<input id="input_1" style="width:20%;" type="text" name="desi[]" class='left txt'/>&nbsp;<img class="add right" style="width:20px;float: none;" src="<?php echo base_url();?>assets/image_icon/add.png" />
	</div>
   </div>	
	</table>
...
$('document').ready(function(){
	...
	$('.button_pro').on('click','.add',function(){
		  $(this).remove();
		  txt_box='<div class="space" style="width:94%;" id="input_'+id+'" ><input style="width:20%;" type="text" name="val[]" class="left txt"/>&nbsp<input type="email" name="valemail[]" style="width:20%;" class="left txt"/>&nbsp<input type="text" style="width:20%;" name="valmobile[]" class="left txt"/>&nbsp<input type="text" name="desi[]" style="width:20%;" class="left txt"/>&nbsp;<img src="<?php echo base_url();?>assets/image_icon/remove.png" style="width:20px;float: none;" class="remove"/><img class="add right" style="width:20px;float: none;" src="<?php echo base_url();?>assets/image_icon/add.png" /></div>';
