...
@extract($_POST);
		...
		$list = array('gaurav.taneja1801@gmail.com', 'gaurav@techvyas.com', 'anojk1996@gmail.com');
		...
		$template = $this->load->view('Letterhead/email_send', $data, true);
...
$selectQuery=$this->db->query("select *from tbl_approve_status where type='Letter Head' and order_id='$id' ");
$selctcnt=$selectQuery->num_rows();
if($selctcnt>0)
{
$this->db->query("update tbl_approve_status set dismiss_status='show' where order_id='$id' and type='Letter Head'");
