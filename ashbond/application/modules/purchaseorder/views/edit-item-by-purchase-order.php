...
<body>
<h4>Edit Purchase Order Item</h4>
<?php 
$idd=$_GET['view'];
$query_dtl=$this->db->query("select * from tbl_purchase_order_dtl where purchase_order_dtl_id='$idd'");
...
?>
<center>
<form method="post" action="editpurchaseorderitem">
<input type="hidden" name="quotation_id_dtl" value="<?php echo $idd;?>" readonly="readonly" />
<input type="hidden" name="quotation_id" value="<?php echo $query_fetch_dtl->purchase_order_hdr_id;?>" readonly="readonly" />
