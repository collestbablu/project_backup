...
$total_bill=0;
 $queryy1="select * from tbl_invoice_payment where status='SalesOrder' and contact_id='$customerfname' and comp_id = '".$this->session->userdata('comp_id')."'";
...
<td width="23%"  class="text-r">
 ...
 <a href="#" onclick="openpopup('invoicereport',900,630,'id','<?php echo $customerfname;?>')" >Received Amount</a>
	<?php }else{ ?>
	Received Amount
	<?php } ?>
</td>
