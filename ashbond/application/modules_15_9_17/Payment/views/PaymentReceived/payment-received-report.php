...
<th>Modes</th>
 ...
 $dd=$line->date;
   ...
   <tr>
	...
	<td><?php if($line->status=='SalesOrder'){?><input type="text" name="billamount[]" id="billamount<?php echo $z;?>" value="<?php echo $line->receive_billing_mount;?>" readonly /><?php } else{?><input type="text" name="billamount[]" id="billamount<?php echo $z;?>" value="0" readonly /><?php }?></td>
	</td>
	...
	?>
	<td><?php if($line->status=='paymentReceived'){?>
	...
	<td><?php if($line->status=='paymentReceived'){?><input type="text" name="billamount[]" id="billamount<?php echo $z;?>" value="<?php echo $c-=$line->receive_billing_mount;?>" readonly /><?php }else {?><input type="text" name="billamount[]" id="billamount<?php echo $z;?>" value="<?php echo $c;?>" readonly /><?php } ?>	</td>
	<td>
