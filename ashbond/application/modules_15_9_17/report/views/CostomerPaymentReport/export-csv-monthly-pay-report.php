...
$supplier='Payment Received CSV';
$contents="Customer Name,Amount,Received Amount,Opening Balance, \n";
  ...
  $contactQuery=$this->db->query("select *from tbl_contact_m where group_name ='4' and contact_id='$line->contact_id'");
