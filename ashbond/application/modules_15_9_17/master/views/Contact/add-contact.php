...
<th style="width: 39%;">Designation</th>
  ...
  <div class="button_pro" style="width:1000px;">
	<div class='space' id='input_1' style="width:94%;">
		<input id="input_1" style="width:20%;" type="text" name="val[]" class='left txt'/>&nbsp;<input id="input_1" style="width:20%;" type="email" name="valemail[]" class='left txt'/>&nbsp;<input id="input_1" style="width:20%;" type="text" name="valmobile[]" class='left txt'/>&nbsp;<input id="input_1" style="width:20%;" type="text" name="desi[]" class='left txt'/>&nbsp;<img class="add right" style="width:20px;float: none;" src="<?php echo base_url();?>assets/image_icon/add.png" />
	</div>
   </div>	
	</table>
