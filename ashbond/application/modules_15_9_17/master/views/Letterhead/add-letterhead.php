...
<td class="text-r"><star>*</star>Contact Name:</td>
			...
			<select name="contact_id" style="width:100px;" <?php if(@$_GET['view']!=''){ ?> disabled="disabled"<?php } ?> required id="contact_id_copy" <?php if(@$_GET['id']!=''){ ?> <?php }else{ ?> onChange="contactfun()" <?php } ?> class="rounded" tabindex="1" <?php if(@$_GET['id']!=''){ ?> <?php }else{ ?> onClick="contactperson()" <?php } ?>>
...
<td class="text-r">Content</td>  
		<?php if($_GET['id']!='' or $_GET['view']!='')
			{?> <td colspan="3"><textarea name="termandcondition" ><?=$row->termandcondition; ?></textarea></td><?php } else {?>       
		<td colspan="3">  <textarea name="termandcondition" style="height:200px;"></textarea></td>
		<?php } ?>
</tr>
</table>
