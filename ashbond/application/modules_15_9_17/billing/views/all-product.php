...
var bbbb=window.opener.document.getElementById("abqt").value=qty;

window.opener.document.getElementById("quantity").value=qty;
...
$squry=$this->db->query("select * from tbl_product_serial where product_id='$Product_id'");
...
$squryF=$squry->row();	
  ...
  <tr>
   ...
   <td><input type="radio" id="cid[]" value="<?php echo $location?>?id=<?php echo $line->Product_id?>" onclick="getCid('<?php echo $line->productname."^".$line->Product_id;?>','<?php echo $line->unitprice_sale;?>','<?php echo $line->unitprice_purchase;?>','<?php echo $usunit;?>','<?php echo $line->quantity; ?>')" name="p" /></td>
