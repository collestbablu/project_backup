...
<td style="width:325px;" ><!--<a target="_blank" href="viewPurchaseOrder?id=<?php echo $line->purchase_order_id ?>"><img src="<?php echo base_url();?>/assets/images/print1.png" alt="v" border="0" class="icon" title="View"/></a>-->
