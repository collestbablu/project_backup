...
<select id="case_id" name="case_name" onChange="loadDoc()" <?php if(@$_GET['view']!=''){ ?> disabled="disabled"<?php } ?>>
	...
	<?php }
	 ?>
		...
		<tr>
					...
					<th>
	<input type="date" required name="date" <?php if(@$_GET['view']!=''){ ?> readonly <?php } ?> value="<?php echo $branchFetch->delivery_date;?>"  style="width:120px;;"/></th>
	...
	<?php
		...
		<tr>
				...
				<th><input type="text" required name="new_ref" <?php if(@$_GET['view']!=''){ ?> readonly <?php } ?> value="<?php echo $branchFetch->new_ref;?>" style="width:250px;"/></th>			
			</tr>		
...
<div class="table-row">
		...
		<table class="bordered"> 
			...
			<tr>
				...
				<td class="text-rig">  <textarea name="termandcondition" id="templateId"><?php echo $branchFetch->termandcondition;?></textarea></td>
