...
<?php if($cntPartNo>0){?>
<td><strong><?php echo  number_format( $invoiceFetch->grand_total,0, '.', ''); ?></strong></td>
<?php }?>
</tr>
...
?>
<td colspan="3" style="text-align:left"><b>AMOUNT : </b><?php echo  words_repues(number_format((float)$inviceres->grand_total, 0, '.', ''));?> </td>
