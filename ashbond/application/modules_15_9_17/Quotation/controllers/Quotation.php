...
public function insertQuotation(){
	...
	$this->db->query("update tbl_communication set date='".$this->input->post('date')."',remark_name='".$this->input->post('remark_name')."',subject='".$this->input->post('subject')."' where communication_type='Quotation' and updateid='$id'");
			...
			$this->db->query("update tbl_quotation_hdr set delivery_date='".$this->input->post('date')."',remark='".$this->input->post('remark_name')."',office_remark_name='$office_remark_name',subject ='".$this->input->post('subject')."',refno='".$refno."',termandcondition='".addslashes($termandcondition)."',template='$template',sub_total='".$this->input->post('sub_total')."',service_charge_percentage ='".$this->input->post('service_chargeper')."',
service_charge='".$this->input->post('service_charge')."',gross_discount_percentage='".$this->input->post('installation_chargeper')."',gross_discount='".$this->input->post('installation_charge')."',grand_total='".$this->input->post('nett')."',contant='$contant_name',new_ref='$new_ref' where quotation_id_hdr='$id'");	
...
$url="assets/quotation_order_pdf/quatation_order".$idd."'.pdf";
	//load the view and saved it into $html variable
