...
<thead>
<tr>
<th colspan="6"><b>Coming Vendor DOD'S</b></th>          
</tr>
<tr>
...
?>
	<tr>
		<td align="center"><?php echo $fetchvdd->vendor_dod;?></td>
		<td align="center"><?php echo $fetchvdd->case_id;?></td>
		<td align="center"><?php echo $fetchvdd->subject;?></td>
		<td align="center"><?php echo $fetchvdd->refno;?></td>
		<td align="center"><?php echo $fetchvdd->grand_total;?></td>
		<td><a target="_blank" href="<?=base_url();?>purchaseorder/PurchaseOrder/viewPurchaseOrder?id=<?php echo $fetchvdd->purchase_order_id; ?>"><img src="<?php echo base_url();?>/assets/images/print1.png" alt="v" border="0" class="icon" title="View"/></a>&nbsp;<a onclick="purchaseignoresed('<?php echo $fetchvd->purchase_order_id;?>')"><img src="<?php echo base_url();?>/assets/images/innore.gif" alt="" border="0" /></a><a onclick="purchasedismissed('<?php echo $fetchvd->purchase_order_id;?>')"> <img src="<?php echo base_url();?>/assets/images/dismiss.gif" alt="" border="0" /></a>
...
<thead>
<tr>
<th colspan="6"><b>Coming Customer DOD's</b></th>         
</tr>
<tr>
...
<td><?php if($fetchvdddd->upload_image!=''){ ?>
<a target="_blank" href="<?=base_url()?>assets/image_data/<?php echo $fetchvdddd->upload_image; ?>"><img src="<?php echo base_url();?>/assets/images/print1.png" alt="v" border="0" class="icon" title="View"/></a>&nbsp; <?php }else{ ?> <?php } ?> <a onclick="salesignoresed('<?php echo $fetchvdss->purchase_order_id;?>')"><img src="<?php echo base_url();?>/assets/images/innore.gif" alt="" border="0" /></a>&nbsp; <a onclick="saledismissed('<?php echo $fetchvdss->purchase_order_id;?>')"> <img src="<?php echo base_url();?>/assets/images/dismiss.gif" alt="" border="0" /></a>
</td>
