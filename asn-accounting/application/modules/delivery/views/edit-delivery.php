...
<?php
	 $ItemQuery=$this->db->query("select * from tbl_delivery where pickup_id='$ID'");
...
<input type="number" step="any" min="0" name="cost" value="<?=$fetch_list->cost;?>" class="form-control"/></div> 
</div>
<div class="form-group"> 
<label class="col-sm-2 control-label">*Conveyance:</label> 
<div class="col-sm-4" id="regid"> 
<input type="number" step="any" name="conveyance" value="<?php echo $fetch_list->conveyance; ?>" class="form-control" required>
</div> 
<label class="col-sm-2 control-label">*Total:</label> 
<div class="col-sm-4" id="regid"> 
<input type="number" step="any" name="total" value="<?php echo $fetch_list->total; ?>" class="form-control" required>
</div> 
</div>
<div class="form-group"> 
...
<input type="hidden" name="vol_wt" value="<?php echo $fetch_list->vol_wt; ?>" class="form-control" >
</div> 
