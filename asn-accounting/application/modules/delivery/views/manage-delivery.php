...
<li class="active"><strong>Delivery List</strong></li>
<div class="pull-right">
<button type="button" class="btn btn-sm" data-toggle="modal" data-target="#modal-0">Add Delivery</button>
...
<tr class="gradeC record" data-row-id="<?php echo $fetch_list->pickup_id; ?>">
<th>
<?php
  ...
  // if($checkProduct=='1')
//{
?><input name="cid[]" type="checkbox" id="cid[]" class="sub_chk" data-id="<?php echo $fetch_list->pickup_id; ?>" value="<?php echo $fetch_list->pickup_id;?>" />
<?php //} else{
	?>
...
<button class="btn btn-default modalEditItem" data-a="<?php echo $fetch_list->pickup_id;?>" href='#editItem' type="button" data-toggle="modal" data-backdrop='static' data-keyboard='false'><i class="icon-pencil"></i></button>
...
<div class="form-group"> 
<label class="col-sm-2 control-label">Total Vol. Wt:</label> 
<div class="col-sm-4" id="regid"> 
<input type="number" step="any" name="unitprice_sale[]" value="<?php echo $fetch_list->total_vol_weight; ?>" readonly="" class="form-control" required>
</div> 
...
<input type="text" style="display:none;" id="table_name" value="tbl_delivery">  
