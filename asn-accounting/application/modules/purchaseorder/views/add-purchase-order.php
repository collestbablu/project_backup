...
?>
<form id="f1" name="f1" method="POST" action="insertPurchaseOrder" onSubmit="return checkKeyPressed(a)" enctype="multipart/form-data">
<!-- Main content -->
  ...
  <script>tinymce.init({ selector:'#tem' });</script>
	...
	<div class="main-content">
		...
		<ol class="breadcrumb breadcrumb-2"> 
			...
			<li><a class="btn btn-success" href="<?=base_url();?>purchaseorder/purchaseorder/manage_purchase_order">Manage Purchase Order </a></li> 
		...
		<ol class="breadcrumb breadcrumb-2"> 
				...
				<li class="active"><strong><a href="#">Manage Purchase</a></strong></li> 
			</ol>
		<?php }?>
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading clearfix">
							<h4 class="panel-title"><strong>Add Purchase</strong></h4>
...
<div class="field">
	<select name="vendor_id"  required id="contact_id_copy" class="form-control" onChange="document.getElementsByName('contactid')[0].value=this.value;"   <?php if(@$_GET['view']!=''){ ?> disabled="disabled" <?php }?>>
		...
		?>
			...
			<?php } ?>
	</select><a style="display:none1" onClick="openpopup('<?=base_url();?>master/Account/add_contact',900,630,'','')"><img src="<?php echo base_url();?>/assets/images/addcontact.png" width="25px" height="25px"/></a>
</div>
...
<select name="invoice_type" class="form-control"  required id="invoice_type"   <?php if(@$_GET['view']!=''){ ?> disabled="disabled" <?php }?>>
		<option value="">Select</option>
			...
			<option value="Tax" <?php if($fetchq->invoice_type=='Tax'){?> selected="selected" <?php }?>>Tax
            </option>
            <option value="No-Tax" <?php if($fetchq->invoice_type=='No-Tax'){?> selected="selected" <?php }?>>No-Tax</option>
...
<th>Upload:</th>
<th>
<input type="file"  class="form-control" required name="image_name" value="" />
</th>
...
<img   src="<?php echo base_url();?>/assets/images/search11.png"  onClick="openpopup('<?=base_url();?>purchaseorder/all_product_function',1200,500,'view',<?=$sales[$i]['1'];?>)" /></div>
...
<th>&nbsp;</th>
<th><input class="btn btn-primary" type="button" value="SAVE"   id="sv1" onclick="fsv(this)" >&nbsp;<a href="<?=base_url();?>salesorder/SalesOrder/manageSalesOrder" class="btn btn-blue">Cancel</a></th></th>
</tr>
</tbody>
</table>
</div>
