...
<label class="col-sm-2 control-label" style="display:none1">Increment:</label> 
<div class="col-sm-4" id="regid" style="display:none1">
<input type="number" name="increment" value="<?php echo $branchFetch->increment; ?>" <?php if($_GET['view']!='') {?> readonly="" <?php }?> class="form-control"> 
<input type="hidden" name="cst_no" value="<?php echo $branchFetch->cst; ?>" class="form-control">
</div> 
</div>
