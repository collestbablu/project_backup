...
<h4 class="panel-title">PICKUP COST REPORT </h4>
<ul class="panel-tool-options"> 
<li><a data-rel="reload" href="#"><i class="icon-arrows-ccw"></i></a></li>
</ul>
</div>
<div class="panel-body">
<form class="form-horizontal" method="post" action="searchPickUpCost">
...
<thead>
<tr class="gradeA">
	   <th><div style="width:100px;">Pickup Date</div></th>
		<th>Customer Name</th>
	    ...
	    <th><div style="width:110px;">Name Of Person</div></th>
...
<?php
$yy=1;
if(!empty($pickupCostSearch)) {
foreach($pickupCostSearch as $rows) {
?>
...
<th style="width:10px;"><?=$rows->total;?></th>
...
<th></th>
<th>Total =</th>
<th><input type="text" name="total" id="total" class="form-control" style="width:100px;" value=""  readonly=""/> </th>
<th>Total Pickup Cost =</th>
<th><input type="text" name="cst_total" id="cst_total" class="form-control" style="width:100px;" value=""  readonly=""/></th>
</tbody>
</table>
<script>
