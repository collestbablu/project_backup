...
if($_GET['id']!='' or $_GET['view']!=''){
	$query=$this->db->query("select * from tbl_bookong_order_hdr where bookingrid='$id' or bookingrid='".$_GET['view']."'");	
	$fetchq=$query->row();
}

?>
<form id="f1" name="f1" method="POST" action="updateBooking" onSubmit="return checkKeyPressed(a)">
<!-- Main content -->
	<div class="main-content">
		...
		<ol class="breadcrumb breadcrumb-2"> 
			...
			<li><a class="btn btn-success" href="<?=base_url();?>SalesOrder/manageSalesOrder">Manage Booking </a></li> 
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading clearfix">
							<h4 class="panel-title"><strong>Update Connection Sheet</strong></h4>
...
<th><input type="text" name="cd_no" class="form-control" value="<?=$fetchq->cd_no;?>"  required <?php if(@$_GET['view']!=''){ ?> disabled="disabled" <?php }?>></th>
<th>Vendor Name</th>
<th>
<div class="field">
	<select name="vendor_id" style="width:80%" required id="contact_id_copy" class="form-control" onChange="document.getElementsByName('contactid')[0].value=this.value;"   <?php if(@$_GET['view']!=''){ ?> disabled="disabled" <?php }?>>
		...
		{
		?>
			<option value="<?php echo $contRow->contact_id; ?>" <?php if($fetchq->vendor_id==$contRow->contact_id){ ?> selected="selected"<?php }?>>
...
<th>
<input type="date"  class="form-control" required name="date_of_booking" value="<?php echo $fetchq->date_of_booking;?>" />
</th>
</tr>
<tr>
<th>Exp. Reach Date</th>
<th>
<input type="date"  class="form-control"  name="exp_reach_date" value="<?php echo $fetchq->exp_reach_date;?>" />
</th>
...
<option value="Air" <?php if($fetchq->mode=='Air'){?> selected="selected" <?php }?>>Air</option>
<option value="Train" <?php if($fetchq->mode=='Train'){?> selected="selected" <?php }?>>Train</option>
<option value="Surface" <?php if($fetchq->mode=='Surface'){?> selected="selected" <?php }?>>Surface</option>
...
<th>Vendor Weight</th>
<th>
<input type="number" step="any"  class="form-control"  name="vendor_weight" value="<?php echo $fetchq->vendor_weight;?>" />
</th>
...
<th>
<input type="text"   class="form-control"  name="remarks" value="<?php echo $fetchq->remarks;?>" />
</th>
...
<?php
$z=1;
$query_dtl=$this->db->query("select * from tbl_bookong_order_dtl where bookinghdr='".$_GET['id']."' or bookinghdr='".$_GET['view']."' ");
foreach($query_dtl->result() as $invoiceFetch)
{


$orginQuery=$this->db->query("select *from tbl_master_data where serial_number='$invoiceFetch->origin'");
$getOrigin=$orginQuery->row();

$designationQuery=$this->db->query("select *from tbl_master_data where serial_number='$invoiceFetch->destination'");
$getDesignation=$designationQuery->row();

?>
<tr>
<td align="center" style="width: 0.2%;"><?php echo $z;?></td>

<td align="center" style="width: 4%;"><input type="text" name="pd[]" id="pd<?php echo $z;?>" value="<?php echo $invoiceFetch->awbno;?>" readonly="" style="text-align: center; width: 100%; border:hidden;">
</td>

<td align="center" style="width: 3%;">
<input type="text" name="origindwe[]" id="originqwq<?php echo $z;?>" value="<?php echo $getOrigin->keyvalue;?>" readonly="" style="text-align: center; width: 100%; border: hidden;">


<input type="hidden" name="origin[]" id="origin<?php echo $z;?>" value="<?php echo $invoiceFetch->origin;?>" readonly="" style="text-align: center; width: 100%; border: hidden;">


<td align="center" style="width: 3%;">


<input type="text" name="destinationdsads[]" id="destinationasdas<?php echo $z;?>" value="<?php echo $getDesignation->keyvalue;?>" readonly="" style="text-align: center; width: 100%; border: hidden;">
<input type="hidden" name="destination[]" id="destination<?php echo $z;?>" value="<?php echo $invoiceFetch->destination;?>" readonly="" style="text-align: center; width: 100%; border: hidden;">


<td align="center" style="width: 3%;"><input type="text" name="rate[]" id="rate<?php echo $z;?>" value="<?php echo $invoiceFetch->rate;?>"readonly="" style="text-align: center; width: 100%; border: hidden;">
<td align="center" style="width: 3%;"><input type="text" name="srate[]" id="srate<?php echo $z;?>" value="<?php echo $invoiceFetch->srate;?>"readonly="" style="text-align: center; width: 100%; border: hidden;">

<td align="center" style="width: 3%;"><input type="text" name="char_wt[]" id="char_wt<?php echo $z;?>" value="<?php echo $invoiceFetch->char_wt;?>"readonly="" style="text-align: center; width: 100%; border: hidden;">
</td>

<td align="center" style="width: 3%;"><input type="text" name="total[]" id="total<?php echo $z;?>" value="<?php echo $invoiceFetch->total;?>"readonly="" style="text-align: center; width: 100%; border: hidden;">
</td>


<td align="center" style="width: 3%;"><input type="text" name="box[]" id="box<?php echo $z;?>" value="<?php echo $invoiceFetch->box;?>"readonly="" style="text-align: center; width: 100%; border: hidden;">
</td>



<td align="center" style="width: 3%;"><input type="text" name="bag[]" id="bag<?php echo $z;?>" value="<?php echo $invoiceFetch->bag;?>"readonly="" style="text-align: center; width: 100%; border: hidden;">
</td>
...
<th>Sub Total</th>
<th>&nbsp;</th>
<th><input type="text" placeholder="Placeholder" id="sub_total" readonly="" name="sub_total" class="form-control" value="<?=$fetchq->sub_total;?>"></th>
</tr>
...
<th>Grand Total</th>
<th>&nbsp;</th>
<th><input type="number" readonly="" step="any" id="grand_total" name="grand_total" placeholder="Placeholder" class="form-control" value="<?=$fetchq->grand_total;?>"></th>
</tr>
...
<th>Total Weight</th>
<th></th>
<th><input type="text" name="total_weight" value="<?php echo $fetchq->total_weight;?>" class="form-control" /></th>
</tr>
...
<th>Actual Weight</th>
<th></th>
<th><input type="text" name="actual_weight" value="<?php echo $fetchq->actual_weight;?>" class="form-control" /></th>
</tr>
...
var origin=document.getElementById("origin"+id).value;
				...
				var srate=document.getElementById("srate"+id).value;
...
document.getElementById("origin").value=origin;
				...
				document.getElementById("char_wt").value=char_wt;	
