...
<?php
$qrgQuery=$this->db->query("select *from tbl_master_data where serial_number='$branchFetch->origin'");
$getOrg=$qrgQuery->row();
?>
<select name="origin" class="form-control" required <?php if(@$_GET['view']!=''){ ?> disabled <?php }?>>

<option value="<?php echo $branchFetch->origin; ?>"><?php echo $getOrg->keyvalue; ?></option>
</select>
</div> 
...
<?php
$desQuery=$this->db->query("select *from tbl_master_data where serial_number='$branchFetch->destination'");
$getDes=$desQuery->row();
?>
<select name="destination" class="form-control" required <?php if(@$_GET['view']!=''){ ?> disabled <?php }?>>
<option value="<?php echo $branchFetch->destination; ?>"><?php echo $getDes->keyvalue; ?></option>
</select>
...
<option value="FTL" <?php if($branchFetch->mode=='FTL'){ ?> selected <?php } ?>>FTL</option>
<option value="Dedicated Vehicle" <?php if($branchFetch->mode=='Dedicated Vehicle'){ ?> selected <?php } ?>>Surface</option>
