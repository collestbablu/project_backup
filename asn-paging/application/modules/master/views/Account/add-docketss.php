...
<?php if($_GET['id']!=''){ ?>
		...
		<?php }else{ ?> 
		<h4 class="panel-title"><strong>Add Docket</strong>&nbsp;<b style="color:#F00"><?php 
...
<div class="col-sm-4"> 			
<input type="hidden" name="doc_val_id" id="doc_val_id" value="" />	
<input type="hidden" name="contact_id" value="<?php echo $branchFetch->contact_id; ?>" />
<input type="text" name="docket_no" id="doc_no" onchange="check_docket(this.value);" value="<?php echo $branchFetch->docket_no; ?>" <?php if($_GET['view']!='') {?> readonly="" <?php }?> class="form-control" required>
</div> 
...
<div class="col-sm-4" id="regid"> 
<input type="text" name="no_of_package" id="no_of_package"  value="<?php echo $branchFetch->no_of_package; ?>" <?php if($_GET['view']!='') {?> readonly="" <?php }?> class="form-control" >
</div> 
<label class="col-sm-2 control-label">Goods:</label> 
<div class="col-sm-4" id="regid"> 
<input type="text" name="goods" id="goods" value="<?php echo $branchFetch->goods; ?>" <?php if($_GET['view']!='') {?> readonly="" <?php }?> class="form-control" ></div> 
</div>

<div class="form-group"> 
<label class="col-sm-2 control-label">*Actual Weight:</label> 
<div class="col-sm-4" id="regid"> 
<input type="text" required name="actual_weight" onchange="cal();" id="at_weight"  value="<?php echo $branchFetch->actual_weight; ?>" <?php if($_GET['view']!='') {?> readonly="" <?php }?> class="form-control" >
</div> 
...
<div class="col-sm-4" id="regid"> 
<input type="number" required min="0" step="any" name="invoice_value" id="inv_val" value="<?php echo $branchFetch->invoice_value; ?>" <?php if($_GET['view']!='') {?> readonly="" <?php }?> class="form-control" >
</div> 
<label class="col-sm-2 control-label">Customer Invoice No.:</label> 
<div class="col-sm-4" id="regid"> 
<input type="text" name="customer_invoice_no" value="<?php echo $branchFetch->customer_invoice_no; ?>" <?php if($_GET['view']!='') {?> readonly="" required <?php }?> class="form-control" ></div> 
</div>
<div class="form-group"> 
<label class="col-sm-2 control-label">*Rate:</label> 
<div class="col-sm-4" id="regid"> 
<input type="number" min="0" step="any" name="rate" id="rate" value="<?php echo $branchFetch->rate; ?>" required class="form-control" readonly="">
</div> 
...
<div class="col-sm-4" id="regid"> 
<input type="date" required  name="booking_date" value="<?php echo $branchFetch->booking_date; ?>" <?php if($_GET['view']!='') {?> readonly="" <?php }?> class="form-control" >
</div> 
<label class="col-sm-2 control-label">EDD:</label> 
<div class="col-sm-4" id="regid"> 
<input type="date" required  name="edd" value="<?php echo $branchFetch->edd; ?>" <?php if($_GET['view']!='') {?> readonly="" <?php }?> class="form-control" ></div> 
</div>
<div class="form-group"> 
<div class="well">
...
<div class="col-sm-4" id="regid"> 
<input type="number" required min="0" step="any" onkeyup="cal();" name="frieght_charge" id="frieght_charge" value="<?php echo $branchFetch->frieght_charge; ?>" <?php if($_GET['view']!='') {?> readonly="" <?php }?> class="form-control" >
</div> 
<label class="col-sm-2 control-label">FOV(in %):</label> 
<div class="col-sm-4" id="regid"> 
<input type="number" min="0" required id="fov" step="any" onchange="cal();" name="fov" value="<?php echo $branchFetch->fov; ?>" <?php if($_GET['view']!='') {?> readonly="" <?php }?> class="form-control" ></div> 
</div>
<div class="form-group"> 
...
<div class="col-sm-4" id="regid"> 
<input type="number" min="0" step="any" id="minWt" name="minimum_weight" value="<?php echo $branchFetch->minimum_weight; ?>" <?php if($_GET['view']!='') {?> readonly="" <?php }?> class="form-control" ></div> 
</div>
<div class="form-group"> 
...
<div class="col-sm-4" id="regid"> 
<input type="number" min="0" step="any" onchange="cal();" id="fuelCharge" name="fuel_charge" value="<?php echo $branchFetch->fuel_charge; ?>" <?php if($_GET['view']!='') {?> readonly="" <?php }?> class="form-control" >
</div> 
...
<div class="col-sm-4" id="regid"> 
<input type="number" required min="0" step="any" onkeyup="cal();" name="total_amount" id="Ttotal" value="<?php echo $branchFetch->total_amount; ?>" <?php if($_GET['view']!='') {?> readonly="" <?php }?> class="form-control" >

</div> 
<label class="col-sm-2 control-label">Chargeable Weight:</label> 
<div class="col-sm-4" id="regid"> 
<input type="number" min="0" step="any"  name="chargeable_weight" id="chargeable_weight" value="<?php echo $branchFetch->chargeable_weight; ?>" <?php if($_GET['view']!='') {?> readonly="" <?php }?> class="form-control" ></div> 
</div>
...
<div class="col-sm-4" id="regid"> 
<input type="number" required min="0" step="any" name="grand_total" id="grand_total" value="<?php echo $branchFetch->grand_total; ?>" <?php if($_GET['view']!='') {?> readonly="" <?php }?> class="form-control" >
</div> 
 ...
 function adda()
		  { 
				...
				if(length!=''){
						...
						var total=Number(Math.ceil(div))*Number(qty);
...
var nopackage=document.getElementById("no_of_package").value;
			...
			var qnty=(Number(qty));
			var totalqty=Number(qnty)+Number(Math.round(nopackage));
...
//if(rc!=0)
//{
var doc_val=document.getElementById("doc_val_id").value;
	if(doc_val==1)
	{
		alert("Docket Number Exits.Please Enter another docket Number");
	}
	//else
	//{
v.type="submit";
...
document.getElementById("chargeable_weight").value=Number(maxWt);

var Ttotal=document.getElementById("Ttotal").value;

var fuelCharge=document.getElementById("fuelCharge").value;

var inv_val= document.getElementById("inv_val").value;
...
var inv_tot=Number(inv_val)*Number(fov)/100;
...
var gTot1=Number(frieght_charge)+Number(other_charges)+Number(codCharge)+Number(oda_charge)+Number(docketCharge);
}
else
{
var gTot1=Number(frieght_charge)+Number(other_charges)+Number(codCharge)+Number(oda_charge)+Number(docketCharge);
}
var fcT=gTot1*fuelCharge/100;
//alert(fcT);
var gTot=Number(frieght_charge)+Number(other_charges)+Number(codCharge)+Number(fcT)+Number(oda_charge)+Number(docketCharge)+inv_tot;
//alert(gTot);
...
function check_docket(doc_no)
{
var strURL="checkDoc?type="+doc_no;
		var req = getXMLHTTP();
		if (req) {
			req.onreadystatechange = function() {
				if (req.readyState == 4) {
...
if(data=='Docket Number Exits.Please Enter another docket Number')
{
	
	document.getElementById("doc_val_id").value='1';
alert(data);

}
else
{
	document.getElementById("doc_val_id").value='2';
}
					} else {
