...
<label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Show
<select name="DataTables_Table_0_length" url="<?=base_url();?>master/Account/manage_docket" aria-controls="DataTables_Table_0" id="entries" class="form-control input-sm">
...
<form method="post" action="update_docket_delivert_status">
...
<tr>
         ...
         <th><div style="width:100px;">Docket No.</div></th>
         ...
         <th><div style="width:100px;">Choose Status</div></th>
		 <th><div style="width:180px;">Shipment Delivered On</div></th>
         <th><div style="width:100px;">Time</div></th>
...
<th><input name="cid[]" type="checkbox" checked="checked" id="cid[]" class="sub_chk" data-id="<?php echo $row->id; ?>" value="<?php echo $row->id; ?>" /></th>
<th><?php echo $i;?></th>
...
<option value="Intransit" <?php if($book=='Intransit'){?> selected="selected" <?php }?>>Intransit</option>
<option value="OFD" <?php if($book=='OFD'){?> selected="selected" <?php }?>>OFD</option>
<option value="Delivered">Delivered</option>
<option value="Not Delivered Return">Not Delivered Return</option>
</select>
</th>
<th><input type="date" name="shipment_delivered_on[]" id="shipment_delivered_on<?php echo $i; ?>" style="width:150px;" /></th>
<th><input type="text" name="shipment_delivered_on_time[]" id="shipment_delivered_on_time<?php echo $i; ?>"  style="width:100px;" /></th>
<th>
...
<a href="#" onClick="openpopup('update_docket',1200,500,'view',<?=$row->id;?>)"><i class="glyphicon glyphicon-zoom-in"></i></a>&nbsp;&nbsp;&nbsp;<a href="#" onClick="openpopup('update_docket',1200,500,'id',<?=$row->id;?>)"><i class="glyphicon glyphicon-pencil"></i>
<?php
$pri_col='id';
$table_name='tbl_docket_entry';
$pri_col_dtl='docket_id';
$table_name_dtl='tbl_docket_entry_dtl';
	?>
	&nbsp;&nbsp;&nbsp;<a href="#" id="<?php echo $row->id."^".$table_name."^".$pri_col; ?>" class="delbuttondocket icon"><i class="glyphicon glyphicon-remove"></i></a> 
...
function exportTableToExcel(tableID, filename = ''){
    ...
    // Specify file name
    filename = filename?filename+'.xls':'DocketEntryList_<?php echo date('d-m-Y');?>.xls';
