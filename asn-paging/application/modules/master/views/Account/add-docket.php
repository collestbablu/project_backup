...
<div class="col-sm-4" id="regid"> 
<input type="number" required min="0" step="any" name="invoice_value" value="<?php echo $branchFetch->invoice_value; ?>" <?php if($_GET['view']!='') {?> readonly="" <?php }?> class="form-control" >
</div> 
...
<div class="col-sm-4" id="regid"> 
<input type="number" min="0" required id="fov" step="any" onkeyup="cal();" name="fov" value="<?php echo $branchFetch->fov; ?>" <?php if($_GET['view']!='') {?> readonly="" <?php }?> class="form-control" ></div> 
</div>
<div class="form-group"> 
