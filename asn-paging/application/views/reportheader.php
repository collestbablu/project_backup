...
<li><a href="#" id="seo_domestic_flights" onmouseover="func(this.id);" class="esp_links_tab active">Consignee/consigner <img src="<?=base_url();?>assets/images/down.png" alt=""></a></li>
<li style="display:none"><a href="#" id="seo_international_flightss" class="esp_links_tab">Sales Order <img src="<?=base_url();?>assets/images/down.png" alt=""></a></li>

<li style="display:none1"><a href="#" id="seo_hotels_india" class="esp_links_tab">Docket <img src="<?=base_url();?>assets/images/down.png" alt=""></a></li>				
</ul>
</div>
</div>
...
<li><a href="<?=base_url();?>report/Report/searchStock/">Consignee/consigner Report</a></li>
<li><a href="<?=base_url();?>report/Report/searchConsignorInvoice/">Consigner Invoice Report</a></li>
<li style="display:none"><a href="<?=base_url();?>report/Report/searchTotalStock/">Location Wise Report</a></li>
<li style="display:none"><a href="<?=base_url();?>report/Report/searchProductStockSummery/">Product Summery Stock Report</a></li>

</a></ul>
<ul class="esp_links_seo clearfix" id="seo_international_flights_content" style="display: none;">
...
<li><a href="#"></a><a href="<?=base_url();?>report/Report/searchDocket/">Docket Report</a></li>
</ul>
</div>
</div>
</div>
...
<script>
      jQuery(document).ready(function () {
          ...
          $("#seo_domestic_flights").hover(function () {
              ...
              $(".esp_seo_link_bg").show();
              $("#seo_international_flights").removeClass('active');
              $("#seo_hotels_india").removeClass('active');
			  $("#seo_international_flightss").removeClass('active');
			  

              $("#seo_international_flights_content").slideUp();
          ...
          $("#seo_international_flights").hover(function () {
              ...
              $("#seo_international_flights").addClass('active');
              $("#seo_international_flights_content").slideDown();
