...
<th>
<input type="date"  class="form-control" required name="Date_of_Supply" value="<?php echo $detail->invoice_date;?>" />
</th>
<td>Place of Supply</td>
<th>
<input type="text"  class="form-control" required name="Place_of_Supply" value="<?php echo $detail->invoice_date;?>" />
</th>
</tr>
</thead>
