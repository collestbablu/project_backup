...
?>
<form id="f1" name="f1" method="POST" action="insertStockRefill" onSubmit="return checkKeyPressed(a)" enctype="multipart/form-data">
<!-- Main content -->
  ...
  <script>tinymce.init({ selector:'#tem' });</script>
	...
	<div class="main-content">
		...
		<ol class="breadcrumb breadcrumb-2"> 
				...
				<li class="active"><strong><a href="#">Add Stock Refill</a></strong></li> 
				<div class="pull-right">
				<a class="btn btn-sm" href="<?=base_url();?>StockRefillNew/manage_stock_refill">Manage Stock Refill</a>
				</div>
			</ol>
		<?php }?>
			<div class="row">
				<div class="col-lg-12">
					<div class="heading">
							<h4 class="panel-title"><strong>Add Stock Refill</strong></h4>
...
<th>Remarks</th>
<th><input type="text" name="remarks" class="form-control" /></th>
<th></th>
...
<th>&nbsp;</th>
<th><input class="btn btn-sm" type="button" name="save" value="SAVE"   id="sv1" onclick="fsv(this)" >&nbsp;<a href="<?=base_url();?>StockRefillNew/manage_stock_refill" class="btn btn-secondary  btn-sm">Cancel</a></th></th>
</tr>
</tbody>
</table>
</div>
