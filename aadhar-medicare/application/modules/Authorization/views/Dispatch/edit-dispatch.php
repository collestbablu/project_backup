...
if($_GET['id']!='' or $_GET['view']!=''){
	$dispatchQuery=$this->db->query("select * from tbl_dispatch_hdr where dispatch_id='".$_GET['id']."' or dispatch_id='".$_GET['view']."'");
$dispatchFetch=$dispatchQuery->row();
}

?>
<form id="f1" name="f1" method="POST" action="approve_dispatch" onSubmit="return checkKeyPressed(a)" enctype="multipart/form-data">
<!-- Main content -->
	<div class="main-content">
		...
		<ol class="breadcrumb breadcrumb-2"> 
			...
			<li><a class="btn btn-success" href="<?=base_url();?>template/manage_template">Manage Template </a></li> 
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading clearfix">
							<h4 class="panel-title"><strong>Approve Dispatch</strong></h4>
...
<input type="hidden" id="typeee" style="width:70px;"   class="form-control"> 
</th>
...
<?php
$z=1;
$query_dtl=$this->db->query("select * from tbl_dispatch_dtl where dispatchhdrId='".$_GET['id']."' or dispatchhdrId='".$_GET['view']."' ");
foreach($query_dtl->result() as $invoiceFetch)
{

$productQuery=$this->db->query("select *from tbl_product_stock where Product_id='$invoiceFetch->item_id'");
...
<td align="center" style="width: 11%;"><input type="text" name="pd[]" id="pd<?php echo $z;?>" value="<?php echo $getProductName->productname;?>^<?php echo $invoiceFetch->item_id;?>" readonly="" style="text-align: center; width: 100%; border:hidden;">
<input type="hidden" name="main_id[]" id="main_id<?php echo $z;?>" value="<?php echo $invoiceFetch->item_id;?>" readonly="" style="text-align: center; width: 100%; border:hidden;"><input type="hidden" value="<?php echo $gettype->keyvalue;?>" name="unit[]" id="unit<?php echo $z;?>" readonly="" style="text-align: center; width: 100%; border: hidden;">
</td>
...
<?php if($_GET['view']!='')
{} else {?>
<input class="btn btn-sm" type="button" value="Dispatch"   id="sv1" onclick="fsv(this)" >&nbsp;
<?php }?>
<a onclick="popupclose(this.value)" class="btn btn-secondary  btn-sm">Cancel</a></th>
</tr>
</tbody>
</table>
</div>
...
// this finction is use for clear data after adding invoice
		...
		document.getElementById("typeee").value='';
