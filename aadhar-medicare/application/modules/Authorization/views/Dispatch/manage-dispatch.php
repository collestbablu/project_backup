...
<ol class="breadcrumb breadcrumb-2"> 
	...
	<li class="active"><strong><a href="#">Manage Dispatch </a></strong></li> 
...
<label>Show
<select name="DataTables_Table_0_length" aria-controls="DataTables_Table_0" id="entries"  url="<?=base_url('/Authorization/dispatch/manage_dispatch');?>" class="form-control input-sm">
...
$i=1;
  ...
  ?>
<tr class="gradeC record" <?php if($sales->dispatched_status==Dispatched){?>style="display:none"<?php }?>>
<th style="display:none;"><input type="checkbox" name="dispatch_id[]" value="<?php echo $sales->dispatch_id; ?>" checked="checked" style="display:none;" /></th>
...
echo $fetchqrow->first_name ;
?></th>
<th><?=$sales->date;?></th>
<th><?=$sales->dispatched_status;?></th>
<th >
<button class="btn btn-sm" onClick="openpopup('<?=base_url();?>Authorization/dispatch/edit_dispatch',1400,600,'id',<?=$sales->dispatch_id;?>)"  type="button" data-toggle="modal" data-backdrop='static' data-keyboard='false'>View</button>
</th>
</tr>
<?php } ?>
</tbody>
