...
<label>Show
<select name="DataTables_Table_0_length" aria-controls="DataTables_Table_0" id="entries"  url="<?=base_url('/report/Report/searchTailor');?>" class="form-control input-sm">
...
$psize=$size->row();
?>
<th><?php if($psize->keyvalue !='')
{ echo $fetchqrow->productname .'   ( '.$psize->keyvalue .')' ; } else { echo $fetchqrow->productname; } ?></th>
