...
<h4 class="panel-title">REORDER LEVEL REPORT </h4>
...
<label>Show
<select name="DataTables_Table_0_length" aria-controls="DataTables_Table_0" id="entries"  url="<?=base_url('/report/Report/searchReorderLevel');?>" class="form-control input-sm">
...
{
?>
<th><?php echo $rows->productname .'   ( '.$psize->keyvalue .')' ; } else { ?></th>
