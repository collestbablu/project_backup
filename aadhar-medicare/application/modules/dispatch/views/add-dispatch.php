...
<form id="f1" name="f1" method="POST" action="insert_dispatch" onSubmit="return checkKeyPressed(a)" enctype="multipart/form-data">
	<div class="main-content">
		...
		<ol class="breadcrumb breadcrumb-2"> 
				...
				<li class="active"><strong><a href="#">Add Dispatch</a></strong></li> 
				<div class="pull-right">
				<a class="btn btn-sm" href="<?=base_url();?>dispatch/manage_dispatch">Manage Dispatch</a>
				</div>
			</ol>
		<?php }?>
			<div class="row">
				<div class="col-lg-12">
					<div class="heading">
							<h4 class="panel-title"><strong>Add Dispatch</strong></h4>
...
<th>
<div class="field">
	<select name="dispatch" class="form-control" onchange="checkCust(this.value)" >
...
<th>Contact Name:</th>
<th>
<select name="contact_id" id="cont_id" class="form-control" >
	<option value="">----Select----</option>
    <?php
...
<th>Date:</th>
<th>
<input name="date"  type="date" value="<?php echo $branchFetch->productname; ?>" class="form-control" required> 
</th>
...
<th>&nbsp;</th>
<th><input class="btn btn-sm" type="button" value="SAVE"   id="sv1" onclick="fsv(this)" >&nbsp;<a href="<?=base_url();?>dispatch/manage_dispatch" class="btn btn-secondary  btn-sm">Cancel</a></th></th>
</tr>
</tbody>
</table>
</div>
