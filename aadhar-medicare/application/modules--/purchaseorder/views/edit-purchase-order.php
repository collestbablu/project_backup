...
if($_GET['id']!='' or $_GET['view']!=''){
	$query=$this->db->query("select * from tbl_purchase_order_hdr where purchaseorderid='$id' or purchaseorderid='".$_GET['view']."'");	
	$fetchq=$query->row();
}

?>
<form id="f1" name="f1" method="POST" action="updatePurchaseOrder" onSubmit="return checkKeyPressed(a)" enctype="multipart/form-data">
<!-- Main content -->
	<div class="main-content">
		...
		<ol class="breadcrumb breadcrumb-2"> 
			...
			<li><a class="btn btn-success" href="<?=base_url();?>SalesOrder/manageSalesOrder">Manage Sales Order </a></li> 
...
<th>Upload:</th>
<th>
<input type="file"  class="form-control" name="image_name" value="<?=$fetchq->image;?>" />
<?php
if($fetchq->image!=''){

?>

<a href="<?=base_url();?>assets/image_data/<?=$fetchq->image;?>" target="_blank"><img src="<?=base_url();?>assets/image_data/<?=$fetchq->image;?>" height="50" width="50" /></a>
<?php } else{?>
<img src="<?=base_url();?>assets/images/no_image.png" height="50" width="50" />
<?php }?>
</th>
</tr>
</thead>
...
<?php
$z=1;
$query_dtl=$this->db->query("select * from tbl_purchase_order_dtl where purchaseorderhdr='".$_GET['id']."' or purchaseorderhdr='".$_GET['view']."' ");
