...
{
if($getContactState->state_id=='13')
	  {
...
<input type="text" id="ty<?php echo $id;?>"  class="prds" value="<?php echo $arr->productname.'' ?>^<?php echo $arr->Product_id; ?>" name="<?php echo $id;?>"
 onFocus="abc(this.value,'<?php echo $arr->unitprice_sale; ?>',this.id,'<?php echo $qty; ?>','<?php echo $usunit; ?>','<?php echo $igst; ?>','<?php echo $arr->quantity; ?>','<?php echo $arr->min_re_level; ?>')"
 onClick="abc(this.value,'<?php echo $arr->unitprice_sale; ?>',this.id,'<?php echo $qty; ?>','<?php echo $usunit; ?>','<?php echo $igst; ?>','<?php echo $arr->quantity; ?>','<?php echo $arr->min_re_level; ?>')" style="width:240px;border:1px solid;" tabindex="-1"  readonly >
