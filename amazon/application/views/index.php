<?php $this->load->view("indexheader.php"); ?>
		...
		<a href="index.html"><img src="<?php echo base_url();?>assets/images/logo.jpg" alt="Integral" title="Integral"></a>
	</div>
		...
		<h2 id="login"><strong>Welcome</strong>, Please Login Here </h2>
			...
			<div class="form-group">
				<input type="text" name="username" placeholder="Username" class="form-control" style="color:#FFFFFF;" required>
			</div>                        
			<div class="form-group">
				<input type="password" placeholder="Password" class="form-control" name="password" style="color:#FFFFFF;" required>
			</div>
