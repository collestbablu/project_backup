...
<h4 class="panel-title heading" style="margin: 0px 0px 5px -15px;"><strong>Add Role Function Action</strong></h4>
...
<div class="panel-body">
 <div class="form-group" style="font-size: small;margin: 0 0 0 -27px;">
...
<?php } } ?>
<div class="col-sm-6" style="margin: 0 0 0 335px;">
