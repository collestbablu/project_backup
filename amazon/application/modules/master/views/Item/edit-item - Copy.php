              ...
              <thead>
               <tr>
                ...
                <tr>
                  ...
                  <td><input name="contract"  type="text"  class="search_box form-control input-sm"  value="" /></td>
                  <td><input name="usages_unit"  type="text"  class="search_box form-control input-sm" value="" /></td>
                  <td><input name="comodity" type="text"  class="search_box form-control input-sm" value="" /></td>
                ...
                ?>
                  ...
                  <td><?=$fetch_list->sku_no;?></td>
                  <td><?=$fetch_list->productname;?></td>
                  
                  <td><?=$fetch_list->contract;?></td>
                  <td><?php
                  $compQuery1 = $this -> db
                             -> select('*')
                  ...
                  ?></td>
                  <td><?=$fetch_list->comodity;?></td>
                  <td><?=$fetch_list->supplier;?></td>
                  <td>
                  <?php if($view!=''){ ?>
