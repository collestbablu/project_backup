...
<?=$fetch_list->prodcatg_name;


$querySub=$this->db->query("select *from tbl_prodcatg_mst where main_prodcatg_id='$fetch_list->prodcatg_id'");
foreach($querySub->result() as $getRes){

echo $getRes->prodcatg_name;
}
?>
