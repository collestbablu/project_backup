...
<!-- Main content -->
<?php
$invoiceCodeQuery=$this->db->query("select *from tbl_invoice_hdr order by invoiceid desc");
$getInvoiceCode=$invoiceCodeQuery->row();
if($fetchq->state_id='29')
{
$codeD=$getInvoiceCode->invoice_no+"1"."/".date("Y",strtotime("-1 year"))."-".date("Y");	
}
?>
<input type="text" name="in" value="<?php echo "KR/000".$codeD;?>" />
<input type="hidden" name="proforma_hdr_id" value="<?=$_GET['id'];?>" />
	...
	<div class="main-content">
		...
		<div class="pull-right">
			<li><a class="btn btn-sm" href="<?=base_url();?>invoice/manage_invoice">Manage Invoice </a></li> 
		</div>	
		</ol>
		<?php }?>
			<div class="row">
				<div class="col-lg-12">
					<div class="heading">
							<h4 class="panel-title"><strong>Convert into Invoice</strong></h4>
...
<option value="25" <?php if($fetchq->state_id=='25'){ ?> selected="selected" <?php }?>>Karnataka</option>
</select>
...
<td>Schedule</td>
<th>
<input type="text"  class="form-control" required name="schedule" value="<?php echo $fetchq->schedule;?>" />
</th>
</tr>
...
<td>No. Of Begs</td>
<th>
<input type="text"  class="form-control" required name="no_of_begs" value="<?php echo $fetchq->no_of_begs;?>" />
</th>


<td>Weight</td>
<th>
<input type="text"  class="form-control" required name="weight" value="<?php echo $fetchq->weight;?>" />
</th>
...
<th>
<input type="text"  class="form-control" required name="dispatch_document_no" value="<?php echo $fetchq->dispatch_document_no;?>" />
</th>
...
<th>
<input type="date"  class="form-control" required name="dispatch_document_date" value="<?php echo $fetchq->dispatch_document_date;?>" />
</th>
...
<input type="text" name="prd"  onkeyup="getdata()" class="form-control" onClick="getdata()" id="prd" style=" width:230px; font-size:11px;"  placeholder=" Search Items..." tabindex="5" >
...
<th>
<input type="text" readonly="" id="qty_stock" class="form-control" style="width:70px;" > 
</th>
...
<th><input type="number" class="form-control" step="any" name="saleamnt" id="discount"  style="width:70px;"/ ></th>
<th><input type="number" class="form-control" step="any" name="saleamnt" id="disAmt"   style="width:70px;"/ ></th>
 <td> 
						 <input  class="form-control" type="text" id="cgst"  onfocus="this.select()" style="width:62px;" readonly></td>	
                         
                         <td> 
						 <input type="text" class="form-control"  id="sgst"  onfocus="this.select()" style="width:62px;" readonly></td>	
                         
                         <td> 
						 <input type="text" class="form-control" id="igst"  onfocus="this.select()" style="width:62px;" readonly></td>
...
<?php }?>
<a href="<?=base_url();?>invoice/manage_invoice" class="btn btn-secondary btn-sm">Cancel</a></th></th>
</tr>
</tbody>
</table>
</div>
