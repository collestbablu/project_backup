...
<th>
<div class="field">
<input type="hidden" name="invoice_no" id="invoice_no" value="<?=$fetchq->invoice_no;?>" />
<select class="form-control" name="state_id" id="state" onchange="getCustomer();" disabled="disabled">
...
<td>Store No.</td>
<th>
<input type="text"  class="form-control" required name="store_no" value="<?php echo $fetchq->store_no;?>" />
</th>
<td>PO No.</td>
<th>
<input type="text"  class="form-control" required name="po_no" value="<?php echo $fetchq->po_no;?>" />
</th>
<td>PO Date</td>
<th>
<input type="date"  class="form-control" required name="po_date" value="<?php echo $fetchq->po_date;?>" />
</th>
...
<td>Eway Bill No.</td>
<th>
<input type="text"  class="form-control"  name="eway_bill_no" value="<?php echo $fetchq->eway_bill_no;?>" />
</th>

<td>Eway Bill Date</td>
<th>
<input type="date"  class="form-control"  name="eway_bill_date" value="<?php echo $fetchq->eway_bill_date;?>" />
</th>
...
<img   src="<?php echo base_url();?>/assets/images/search11.png" style="display:none;"  onclick="showall()" onMouseOver="showall1()" /></div>
