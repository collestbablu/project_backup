					 <?php
						...
						$order_date  = "";$company          ="";    $dtlData	    ='';$consignee_id='';
                     ...
                     ?>
										 ...
										 <div class="form-group">
										  <div class="col-sm-3">
										   ...
										   <div class="col-sm-3">
										 	<label for="po_order">Requestor Destination:</label>
											   ...
											   <select name="destination" required  id="destination" class="form-control">
										  ...
										  <div class="col-sm-3">
											<label for="contact_id_copy">REQUETOR CONTACT:</label>
												<select name="contact_id"   id="contact_id_copy" class="form-control">
													<option value="" selected disabled>Select</option>
													<?php
						...
						<select name="consignee_id"    class="form-control">
							...
							{
							?>
								<option value="<?php echo $contRow->contact_id; ?>" <?=$contRow->contact_id==$consignee_id?'selected':'';?>>
								<?php echo $contRow->first_name.' '.$contRow->middle_name.' '.$contRow->last_name; ?>
								</option>
							<?php } ?>
						</select>
