 ...
 <!-- Main content -->
  <div class="main-content">
				...
				<div class="col-lg-12" id="listingData">
					<div class="panel panel-default">
						<div class="panel-heading clearfix">
							<h4 class="panel-title">View Details</h4>
	...
	<!-- <div class="table-responsive-">
      ...
      <?php
		$productQuery=$this->db->query("select * from tbl_purchase_order_dtl where purchaseorderhdr='$id'  ");
			$i=1;
       ...
       <tr class="gradeX odd" role="row">
                                            ...
                                            <?php
										//	echo "select SUM(qty) as po_qty from tbl_inbound_log where po_no='$getHdr->po_no' and productid='$getProduct->productid'";
											
											$poLogQuery=$this->db->query("select SUM(receive_qty) as rec_qty from tbl_inbound_log where productid='$getProduct->productid' and po_no='$getProduct->purchaseorderhdr'");
						...
						$inbountLogGRNQuery=$this->db->query("select SUM(receive_qty) as rec_qty from tbl_inbound_log where productid='$getProduct->productid' and po_no='$getProduct->purchaseorderhdr'");
