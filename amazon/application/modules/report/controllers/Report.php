...
function Manage_Product_location()
{
		 ...
		 $totalData   = $this->model_report->count_location($table_name,'A',$this->input->get());

		 if($_GET['entries']!="" && $_GET['filter'] == 'filter'){
			$url   = site_url('/report/Report/searchlocation?entries='.$_GET['entries']);
		  } elseif($_GET['filter'] == 'filter' || $_GET['entries'] != ''){
		  	$url   = site_url('/report/Report/searchlocation?entries='.$_GET['entries'].'&s_loc='.$_GET['s_loc'].'&p_name='.$_GET['p_name'].'&filter='.$_GET['filter']);
...
function Manage_grn_Stock()
{
		 ...
		 $totalData   = $this->model_report->count_grn($table_name,'A',$this->input->get());

		 if($_GET['entries']!="" && $_GET['filter'] != 'filter'){
				$url   = site_url('/report/Report/grn_report?entries='.$_GET['entries'].'&s_loc='.$_GET['s_loc'].'&po_no='.$_GET['po_no'].'&in_no='.$_GET['in_no'].'&invoice_date='.$_GET['invoice_date'].'&grn_no='.$_GET['grn_no'].'&grn_no='.$_GET['grn_no'].'&f_date='.$_GET['f_date'].'&t_date='.$_GET['t_date'].'&filter='.$_GET['filter']);
		  
		  }
		  elseif($_GET['filter'] == 'filter' || $_GET['entries'] != ''){
		  	$url   = site_url('/report/Report/grn_report?entries='.$_GET['entries'].'&s_loc='.$_GET['s_loc'].'&po_no='.$_GET['po_no'].'&in_no='.$_GET['in_no'].'&invoice_date='.$_GET['invoice_date'].'&grn_no='.$_GET['grn_no'].'&f_date='.$_GET['f_date'].'&t_date='.$_GET['t_date'].'&filter='.$_GET['filter']);
