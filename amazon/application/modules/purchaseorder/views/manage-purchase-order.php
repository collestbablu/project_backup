			 ...
			 <div class="panel panel-default">
                ...
                <div class="table-responsive">
		          <table class="table table-striped table-bordered table-hover dataTables-example1" id="tblData" >
					<thead>
					 <tr>  <th><div style="width:30px;">S.No&nbsp;</div></th>
						   <th><div style="width:120px;">Storage Location</div></th>
                           <th><div style="width:130px;">Purchase Order No.</div></th>
                            <th><div style="width:210px;">SUPPLIER CONTACT</div></th>
						   <th><div style="width:125px;">Purchase Contact</div></th>
                           <th><div style="width:100px;">Order Date</div></th>
                           <th><div style="width:100px;">Revised Date</div></th>
                           <th><div style="width:100px;">REVISED BY</div></th>
						   <th><div style="width:115px;">Purchase Status</div></th>
						...
						<tr>
						    <form method="get">
								...
								<!-- <td><input name="supplier" type="text"  class="search_box form-control input-sm" value="" /></td> -->
						...
						?>
                         <tr class="gradeC record">
                            ...
                            <td><a data-toggle="modal" data-target="#modal-2" onclick="inbondviewlog('<?=$sales->purchaseid;?>');"><?=$sales->purchase_no;?></a></td>
                            ...
                            <td><?=$sqlporesult->first_name;?></td>
							<td><?=$sales->order_date;?></td>
                            <td><?=$sales->revised_date;?></td>
							<td><?=$sales->revised_by;?></td>
						<!--<td><?=$sales->ship_vip;?></td> -->
							<td><?php
							$countPoQty=$this->db->query("select SUM(receive_qty) as qtyCnt from tbl_inbound_log where po_no='$sales->purchaseid'");
							$getPocount=$countPoQty->row();
                            if($getPocount->qtyCnt>0)
							{
								echo "Part Pending";
							}
							else
