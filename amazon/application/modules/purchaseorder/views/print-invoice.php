...
<tr class="tr-t">
  ...
  <td>&nbsp;</td>
  <td colspan="3" class="td-l"><strong>WFF Date:</strong></td>
  <td colspan="7"><?=$inviceres->wff_date;?></td>
  </tr>

<tr>
<td colspan="3"><strong>PO. Date:</strong></td>
<td colspan="4"><?php $date_in=explode("-",$inviceres->invoice_date); 
  $monthNum  = $date_in[1];
  $dateObj   = DateTime::createFromFormat('!m', $monthNum);
  $monthName = $dateObj->format('F');	  echo $date_in[2].'-'.$monthName.'-'.$date_in[0]; ?></td>
<td width="52">&nbsp;</td>
<td colspan="3" class="td-l"><strong>Valid Till Date :</strong></td>
<td colspan="7"><?=$inviceres->valid_till_date;?></td>
</tr>
...
<td>&nbsp;</td>
<td colspan="3" class="td-l"><strong>Reference :</strong></td>
<td colspan="7"><?=$inviceres->reference;?></td>
</tr>

<tr>
<td colspan="2"><strong>Place of Supply :</strong></td>
<td width="200" colspan="1">&nbsp;</td>
<td colspan="4"><?=$inviceres->Place_of_Supply;?></td>
