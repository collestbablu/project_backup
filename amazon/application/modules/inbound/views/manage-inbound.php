...
?>
	...
	<div class="main-content">
			...
			<ol class="breadcrumb breadcrumb-2"> 
                ...
                <li><a class="active">Manage Inbound</a></li> 
              <!--   <li ><strong>Add Item11</strong></li> -->
			
                <div class="pull-right">
                   <a class="btn btn-sm btn-black btn-outline" href="<?=base_url();?>inbound/add_inbound"><i class="fa fa-plus" aria-hidden="true"></i>Add GRN</a>
	     ...
	     <div class="row">
			 ...
			 <div class="panel panel-default">
				<div class="panel-heading clearfix">
				  <h4 class="panel-title">Manage Inbound</h4>
				...
				<div class="col-sm-5">
				<label>Show 
                <select   name="DataTables_Table_0_length" url="<?=base_url();?>inbound/manage_inbound?<?='location='.$_GET['location'].'&po_no='.$_GET['po_no'].'&date='.$_GET['date'].'&invoice_no='.$_GET['invoice_no'].'&grn_no='.$_GET['grn_no'].'&invoice_date='.$_GET['invoice_date'];?>" id="entries" class="">
					 ...
					 <tr>  <th>&nbsp;</th>
						...
						<tr>
						    <form method="get">
								...
								<td><input  name="invoice_no"  type="text"  class="search_box form-control input-sm" value="" /></td>
								...
								<td><input name="invoice_no"  type="date"  class="search_box form-control input-sm" value="" /></td>
								
								<td><button type="submit" class="btn btn-sm btn-black btn-outline" name="filter" value="filter">
									<span>Search</span>
								    </button>
								</td>
							</form>
						...
						<!-- 	<td><?=$sales->ship_vip;?></td> -->
							...
							<td>
							 <button class="btn btn-xs btn-black"  type="button" data-toggle="modal" data-target="#modal-0" onclick="viewInbound('<?=$sales->inboundid;?>');"> <i class="icon-eye"></i></button>
                             
						    
                             <button style="display:none" class="btn btn-xs btn-black delbuttonPurchase" id="<?=$sales->purchaseid."^".$table_name."^".$pri_col ; ?>" type="button"><i class="icon-trash"></i></button>
                             
                             
<a href="mrn_print?id=<?=$sales->inboundid;?>" target="_blank"><button class="btn btn-xs btn-black"  type="button"><i class="glyphicon glyphicon-print"></i></button></a>
