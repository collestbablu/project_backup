  ...
  <script>tinymce.init({ selector:'#tem' });</script>
	...
	<div class="main-content">
		<ol class="breadcrumb breadcrumb-2"> 
				...
				<a class="btn btn-sm" href="<?=base_url();?>purchaseorder/manage_purchase_order">Manage Purchase Order</a>
				</div>
			</ol>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="heading">
							...
							<h4 class="panel-title"><strong>Add Purchase Order</strong></h4>
...
<th><input type="text" name="purchase_no" onkeyup="duplicate_po_check(this.value);" class="form-control"  required <?php if(@$_GET['view']!=''){ ?> disabled="disabled" <?php }?>></th>
<th>State</th>
<th>
<div class="field">
...
<td>Freight</td>
<th>
<input type="text"  class="form-control" required name="freight" id="freight" value="<?php echo $detail->freight;?>"  />
</th>
