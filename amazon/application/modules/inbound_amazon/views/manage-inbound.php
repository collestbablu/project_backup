...
?>
	...
	<div class="main-content">
			...
			<ol class="breadcrumb breadcrumb-2"> 
                ...
                <li><a class="active">View Inbound</a></li> 
              <!--   <li ><strong>Add Item11</strong></li> -->
			
                <div class="pull-right">
                   <a style="display:none" class="btn btn-sm btn-black btn-outline" href="<?=base_url();?>inbound/add_inbound"><i class="fa fa-plus" aria-hidden="true"></i>Add GRN</a>
