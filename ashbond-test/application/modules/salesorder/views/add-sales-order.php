...
<th id="sodiv">
<select name="idser" id="idser" required onChange="sofunction()" style="width: 60px;">
	<option value="">--select--</option>
	...
	<input type="date" required name="date" <?php if(@$_GET['view']!=''){ ?> readonly <?php } ?> value="<?php echo $row->date;?>"  style="width:120px;;"/></th>
					...
					<th><input type="text"  name="remark_name" <?php if(@$_GET['view']!=''){ ?> readonly <?php } ?> value="<?php echo $row->remark_name;?>"/></th><th></th>
				</tr>		
	<tr>	
	...
	<?php
		...
		<tr>
				...
				<th colspan="4"><textarea name="contant_name" style="width:405px;height:40px;"></textarea></th>			
			</tr>
		</table>
		...
		<table class="bordered"> 
            ...
            <tr>
				...
				<td class="text-rig"> &nbsp;
				  ...
				  <input type="text" id="cgst_per_total" name="cgst_per_total" value="" style="width:150px; font-size:16px; text-align:right;" readonly="" /></td>
			</tr>
            ...
            <tr>
				...
				<td class="text-rig"> &nbsp;
				  ...
				  <input type="text" id="cgst_per_total_two" name="cgst_per_total_two" value="" style="width:150px; font-size:16px; text-align:right;" readonly="" /></td>
			</tr>
            ...
            <tr>
				...
				<td class="text-rig"> &nbsp;
				  ...
				  <input type="text" id="sgst_per_total" name="sgst_per_total" value="" style="width:150px; font-size:16px; text-align:right;" readonly="" /></td>
			</tr>
            <tr>
				...
				<td class="text-rig"> &nbsp;
				  ...
				  <input type="text" id="sgst_per_total_two" name="sgst_per_total_two" value="" style="width:150px; font-size:16px; text-align:right;" readonly="" /></td>
			</tr>
             <tr>
				...
				<td class="text-rig"> &nbsp;
				  ...
				  <input type="text" id="igst_per_total" name="igst_per_total" value="" style="width:150px; font-size:16px; text-align:right;" readonly="" /></td>
			</tr>
<tr>
				...
				<td class="text-rig"> &nbsp;
				  ...
				  <input type="text" id="igst_per_total_two" name="igst_per_total_two" value="" style="width:150px; font-size:16px; text-align:right;" readonly="" /></td>
			</tr>
<tr>
				...
				<td class="text-rig"> &nbsp;
				  ...
				  <input type="text" id="gst_total_two" name="gst_total_two" value="" style="width:150px; font-size:16px; text-align:right;" readonly="" /></td>
			</tr>
            <tr>
				...
				<td class="text-rig"> &nbsp;
				  ...
				  <input type="text" id="discount_amount_total" name="discount_amount_total" value="" style="width:150px; font-size:16px; text-align:right;" readonly="" /></td>
			</tr>
...
function closeWinCan(){
    window.location.assign("<?php echo base_url();?>salesorder/SalesOrder/manageSalesOrder");  
}
