...
@extract($_POST);
	...
	if(@$_GET['popup']=='True') {
		...
		if($vendor_id!='')
		{
		 ...
		 echo $queryy.=" and vendor_id ='$vendor_id'";
   ...
   <tr>
	...
	<td>
	<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal<?php echo $i;?>" data-whatever="@mdo"> <?php echo $line->author_date;?></button>
