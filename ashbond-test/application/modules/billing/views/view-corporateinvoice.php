...
?></td>
    <td style="text-align:center; border: none; border-left:1px solid black;"><?php echo  $invoiceFetch->qty;?></td>
    ...
    <td class="total-line" style= "border: none;border-left:1px solid black;text-align:center;"><?php echo number_format( $pfetch->unitprice_sale,2, '.', '');  ?></td>
    
    <td class="total-line" style= "border: none;border-left:1px solid black;text-align:center;"colspan="2"><span class="total-line" style="border: none;border-right:1px ;text-align:center;"><?php echo $ntp=number_format( $invoiceFetch->total_price,2, '.', ''); ?></span></td>
    <?php $n++;}?>
  </tr>
  <!--Deltail part ended-->
  ...
  <tr>
    ...
    <td class="total-line" colspan="2"><span class="total-line" style="border: 1px;border-right:1px;border-left:1px;text-align:center;"><?php echo number_format($inviceres->balance_total,2, '.', ''); ?></span></td>
  ...
  <tr>
    ...
    <td class="total-line" colspan="2"><strong><?php echo @number_format($inviceres->service_tax_per,2, '.', ''); ?></strong><br/>
	<?php echo $inviceres->service_tax ;?></td>
  </tr>
  

  <tr>
    <td class="total-line"  colspan="2">Discount%<br/>Amount</td>
    <td class="total-line" colspan="2"><strong><?php echo @number_format($inviceres->installation_charge_per ,2, '.', ''); ?></strong><br/><?php echo @number_format($inviceres->installation_charge_per ,2, '.', ''); ?></td>
	  </tr>
	  </td>
  </tr>
