...
<thead>
<tr>
<th colspan="4"><b>Search Vendor List</b></th>        
</tr>
</thead>
...
Vendor Name:</td>
 ...
 <?php $selectrr1="select * from tbl_contact_m where group_name='3'";
...
@extract($_GET);
   ...
   <tr>
	...
	<td ><a onClick="openpopup('<?php echo base_url();?>Payment/Payment/invoicereport',1000,600,'id',<?php echo $line->contact_id; ?>)">
	<?php 
		$sql = $this->db->query("select * from tbl_contact_m where group_name ='3' and contact_id='$line->contact_id'");
