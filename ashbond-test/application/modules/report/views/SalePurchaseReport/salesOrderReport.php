...
<thead>
<tr>
<th colspan="4"><b>Search Sales Order List</b></th>        
</tr>
</thead>
...
@extract($_GET);
   ...
   <tr>
	...
	<td>
	<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal<?php echo $i;?>" data-whatever="@mdo"> <?php echo $line->delivery_date;?></button>
...
<div class="modal fade" id="exampleModal<?php echo $i;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="width:800px;height:200px;; margin-left:-87px;">
	 ...
	 <strong>List Price</strong>
	  ...
	  <?php
						$queryProduct=$this->db->query("select *from tbl_sales_order_dtl where salesid='$line->purchase_order_id'");
