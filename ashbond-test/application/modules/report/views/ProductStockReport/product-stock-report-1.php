...
<a href="print_product_stockreport_1<?php echo $_SERVER['REQUEST_URI'];?>" target="_blank" class="submit"><strong>Print</strong></a>&nbsp; | <a href="export_csv_product_stock_report_1<?php echo $_SERVER['REQUEST_URI'];?>" class="submit"><strong>Export</strong></a>
