...
$getSO=$SOQuery->row();
?>
<form method="post" action="<?=base_url();?>salesordernew/SalesOrderNew/send_mail_functionss">
<div id="container">
...
<center><label><input class="submit" type="submit" name="send" value="Send" /></label></center>
</div>
