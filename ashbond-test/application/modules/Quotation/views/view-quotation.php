...
<strong><u style="margin: 0 0 8px 0px;">Kind Attn</u><b style="font-weight: 600; margin: 0 0 2px 0px; float: left;">.&nbsp;:&nbsp;</b></strong><b style="font-weight: 600; margin: 0 0 2px 0px;"><?=$fetchkind->p_name?></b>
<div id="clear"></div>
<div id="line"></div>
<strong><u>Sub</u><b style="font-weight: 600; margin: 0 0 2px 0px; float: left;">.&nbsp;:&nbsp;</b></strong><b style="font-weight: 600; margin: 0 0 2px 0px;"><?=$inviceres->subject?></b>
<div id="clear"></div>
<div id="line"></div>
<strong><u>Ref</u><b style="font-weight: 600; margin: 0 0 2px 0px; float: left;">.&nbsp;:&nbsp;</b></strong><strong><b style="font-weight: 600; margin: 0 0 2px 0px;"><?=$inviceres->new_ref?></b></strong>
<div id="clear"></div>
<div id="line"></div>
<div id="line"></div>
<?=$inviceres->contant?>
...
<td colspan="2"><b>AMOUNT :</b><strong> <?php echo  words_repues(number_format((float)$inviceres->grand_total, 0, '.', ''));?><?php if($inviceres->grand_total!=''){ ?>Only <?php } ?></strong></td>
<?php }?>
<td>&nbsp;</td>
<td style="text-align:center;"><strong>TOTAL</strong></td>
<td style="text-align:center">&nbsp;</td>
<?php if($cntPartNo>0){?>
<td><strong><?php echo  number_format( $invoiceFetch->grand_total,2, '.', ','); ?><span style="text-align:right"><strong><?php echo  number_format( $invoiceFetch->grand_total,2, '.', ','); ?></strong></span></strong></td>
<?php }?>
</tr>
...
<td style="text-align:center"><strong><?php if($cntPartNo==0){?><?php echo  number_format( $inviceres->grand_total,2, '.', ','); ?><?php } else {?>TOTAL<?php }?></strong></td>
<?php if($cntPartNo>0){?>
<td style="text-align:center"><strong><?php echo  number_format( $inviceres->grand_total,2, '.', ','); ?></strong></td>
<?php }?>
</tr>
