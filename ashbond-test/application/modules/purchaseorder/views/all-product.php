...
$squryF=$squry->row();	
  ...
  <tr>
   ...
   <td><input type="radio" id="cid[]" value="<?php echo $location?>?id=<?php echo $line->Product_id?>" onclick="getCid('<?php echo $line->productname."^".$line->Product_id;?>','<?php echo $line->unitprice_purchase;?>','<?php echo $usunit;?>','<?php echo $usunit;?>','<?php echo $squryF->quantity; ?>','<?php echo $line->part_no; ?>','<?php echo $line->unitprice_sale; ?>')" name="p" /></td>
