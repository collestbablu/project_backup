...
<input type="text" id="ty<?php echo $id;?>"  class="prds" value="<?php echo $arr->productname.'' ?>^<?php echo $arr->Product_id; ?>" name="<?php echo $id;?>"
 onFocus="abc(this.value,'<?php echo $arr->unitprice_purchase; ?>',this.id,'<?php echo $qty; ?>','<?php echo $usunitid."^".$usunit; ?>','<?php echo $des; ?>','<?php echo $arr->unitprice_sale; ?>')"
 onClick="abc(this.value,'<?php echo $arr->unitprice_purchase; ?>',this.id,'<?php echo $qty; ?>','<?php echo $usunitid."^".$usunit; ?>','<?php echo $des; ?>','<?php echo $arr->unitprice_sale; ?>')" style="width:100%;border:none;border-bottom:1px solid;border-left:1px solid;" tabindex="-1"  readonly >
