...
<form id="f1" name="f1" method="POST" action="insertPurchaseOrder">
	...
	<?php
		...
		<tr>
				...
				<th><input type="text" name="new_ref_no" ></th>
					...
					<th><input type="date" name="vendor_dod" <?php if(@$_GET['view']!=''){ ?> readonly <?php } ?> value="<?php echo $row->customer_dod;?>"/></th>
				</tr>
		<tr>
				...
				<th><textarea name="contant_name" style="width:405px;height:40px;"></textarea></th>			
					...
					<th><input type="date" name="reminder_date" value="" /></th>		
			</tr>
			<tr>
				<th class="text-r">&nbsp;</th>
...
function closeWinCan(){
    window.location.assign("<?php echo base_url();?>purchaseorder/PurchaseOrder/managePurchaseOrder");  
}
