...
<td><input name="undergroup" id="undergroup" readonly="readonly" type="<?php if($az==1){ echo "text";}else{echo"hidden";} ?>" class="span6" value="<?php if(@$ungroup->prodcatg_name!='') { echo $ungroup->prodcatg_name;}else{ 
