...
<td class="text-r"><star>*</star>Contact Name:</td>
		...
		<?php }else{ ?>
			<select name="contact_id" style="width:100px;" <?php if(@$_GET['view']!=''){ ?> disabled="disabled"<?php } ?> required id="contact_id_copy"  onChange="contactfun()"  class="rounded" onClick="contactperson()">
