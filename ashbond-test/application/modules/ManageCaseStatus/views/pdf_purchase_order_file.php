...
<title>Purchase Order Sent List</title>
</head>

<body>
<h1><u>Purchase Order Sent List</u></h1> 
<table width="100%" border="1">
 ...
 <?php
		  ...
		  $queryy="select * from tbl_new_case where action_status='Purchase-Order-Sent' order by new_case_id desc";
