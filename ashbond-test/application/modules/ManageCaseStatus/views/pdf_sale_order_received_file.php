...
<title>Sale Order Received List</title>
</head>

<body>
<h1><u>Sale Order Received List</u></h1> 
<table width="100%" border="1">
 ...
 <?php
		  ...
		  $queryy="select * from tbl_new_case where action_status='Sale-Order-Received' order by new_case_id desc";
