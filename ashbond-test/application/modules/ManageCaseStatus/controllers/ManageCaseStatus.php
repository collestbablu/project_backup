...
public function manageCompleted(){
	if($this->session->userdata('is_logged_in')){
		$this->load->view('manage-Completed');
	}
	else
	{
	redirect('index');
...
public function save_download_pdf_file_cancel()
  { 
...
@extract($_POST);
 ...
 $url="Cancel List".$idd."'.pdf";

	//load the view and saved it into $html variable

		$html=$this->load->view('pdf_cancel_file', $data, true);
...
public function save_download_pdf_file_completed()
  { 
...
@extract($_POST);
 ...
 $url="Completed List".$idd."'.pdf";

	//load the view and saved it into $html variable

		$html=$this->load->view('pdf_completed_file', $data, true);
