...
if(document.getElementById("series").value == ""){
		 alertify.alert("Series emty");
	 return;
	}
	if(document.getElementById("datepicker").value == ""){
		 alertify.alert("date emty");
	 return;
	}
	if(document.getElementById("voucher").value == ""){
		 alertify.alert("voucher emty");
	 return;
	}
	if(document.getElementById("sale_type").value == ""){
		 alertify.alert("sale_type emty");
	 return;
	}
	if(document.getElementById("mcentr").value == ""){
		 alertify.alert("sale_type emty");
	 return;
	}
	if(document.getElementById("party").value == ""){
		 alertify.alert("party emty");
	 return;
	}
	if(document.getElementsByName("pid[]")[0].value ==''){
			if(document.getElementsByName("item[]")[0].value !=''){
		 	alertify.alert("Invalid Name emty");
			 return;
		 }else{}
		  alertify.alert("Select product emty");
	 	return;
	}
	if(document.getElementsByName("bil[]")[0].value !=''){
			if(document.getElementsByName("bid[]")[0].value ==''){
		 	alertify.alert("Invalid bill emty");
			 return;
		 }else{}
		 	}
			alertify.alert("submit form");
	$( "#Busy" ).submit();
