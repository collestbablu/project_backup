	...
	for($list_day = 1; $list_day <= $days_in_month; $list_day++):
		$calendar.= '<td class="calendar-day">';
			...
			while($result21=mysql_fetch_array($idfetch1))
			{
				...
				$t="Task ".$i;
				if($result21["nxt_action_date"] !=''){$t=$result21["first_name"]."_".$sname."(".$result21["lead_id"].")";}
				...
				$calendar.= '<a href="#" data-toggle="modal" onclick="addActivity('.$url.');" data-target="#modal-1">'.$t.'</a><br>';
