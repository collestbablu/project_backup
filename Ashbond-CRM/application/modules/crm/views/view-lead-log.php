...
<div class="col-sm-4"> 
<select name="contact_id"   class="form-control"   required <?php if(@$_GET['view']!=''){ ?> disabled="disabled" <?php }?> >
...
<?php
	$i=1;
  $queryLead=$this->db->query("select *from tbl_leads_log where lead_log_id='".$_GET['id']."'");
