...
<ol class="breadcrumb breadcrumb-2"> 
	...
	<li><a>Crm</a></li> 
	<li><a>Lead</a></li> 
	<li class="active"><strong><a>Manage Lead</a></strong></li> 
...
<label>Show
<select name="DataTables_Table_0_length" url="<?=base_url('crm/Lead/manage_lead').'?lead_number='.$_GET['lead_number'].'&tour_id='.$_GET['tour_id'].'&user='.$_GET['user'].'&customer='.$_GET['customer'].'&sales_person='.$_GET['sales_person'].'&contact_person='.$_GET['contact_person'].'&subject='.$_GET['subject'].'&priority='.$_GET['priority'].'&closure_date='.$_GET['closure_date'].'&source='.$_GET['source'].'&stage='.$_GET['stage'].'&filter='.$_GET['filter'];?>" aria-controls="DataTables_Table_0" id="entries" class="form-control input-sm">
...
<th><div style="width:150px;">Lead Number</div></th>
...
<th><div style="width:150px;">Subject</div></th>
