...
<div class="col-sm-3"> 
<select name="category"   class="form-control ui fluid search dropdown email">
...
<label>&nbsp;&nbsp; Show
<select name="DataTables_Table_0_length" aria-controls="DataTables_Table_0" id="entries"  url="<?=base_url('/report/Report/searchStock').'?p_name='.$_GET['p_name'].'&category='.$_GET['category'].'&filter='.$_GET['filter'];?>" class="form-control input-sm">
...
<th style="display:none"><?php echo round($rows->quantity,2); ?></th>
</tr>
<?php } //} ?>
</tbody>
</table>
