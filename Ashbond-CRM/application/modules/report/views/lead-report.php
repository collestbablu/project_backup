...
<label>&nbsp;&nbsp; Show
<select name="DataTables_Table_0_length" aria-controls="DataTables_Table_0" id="entries"  url="<?=base_url('/report/Report/searchLead').'?contact_id='.$_GET['contact_id'].'&sale_person_id='.$_GET['sale_person_id'].'&filter='.$_GET['filter'];?>" class="form-control input-sm">
