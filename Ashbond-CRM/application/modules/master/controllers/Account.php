...
function manage_contactJoin()
{
	  ...
	  {
	  	$url = site_url('/master/Account/manage_contact?company_name='.$_GET['company_name'].'&primary_contact='.$_GET['primary_contact'].'&group_name='.$_GET['group_name'].'&email_id='.$_GET['email_id'].'&mobile_no='.$_GET['mobile_no'].'&filter='.$_GET['filter'].'&entries='.$_GET['entries']);
	  }
	  else
	  {
	  	$url = site_url('/master/Account/manage_contact?');
