...
public function Manage_Product_List()
{
		  ...
		  {
			$url = site_url('/master/Item/manage_item?sku_no='.$_GET['sku_no'].'&hsn_code='.$_GET['hsn_code'].'&productname='.$_GET['productname'].'&description='.$_GET['description'].'&category='.$_GET['category'].'&usageunit='.$_GET['usageunit'].'&unitprice_purchase='.$_GET['unitprice_purchase'].'&gst_tax='.$_GET['gst_tax'].'&unitprice_sale='.$_GET['unitprice_sale'].'&filter='.$_GET['filter'].'&entries='.$_GET['entries']);
		  }
		  else
		  {
			$url = site_url('/master/Item/manage_item?');
