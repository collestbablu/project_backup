...
<ol class="breadcrumb breadcrumb-2"> 
	...
	<li><a>Master</a></li> 
	<li><a>Contact</a></li> 
	<li class="active"><strong><a>Manage Contact</a></strong></li> 
...
<label>Show
<select name="DataTables_Table_0_length" aria-controls="DataTables_Table_0" id="entries"  url="<?=base_url('master/Account/manage_contact').'?company_name='.$_GET['company_name'].'&primary_contact='.$_GET['primary_contact'].'&group_name='.$_GET['group_name'].'&email_id='.$_GET['email_id'].'&mobile_no='.$_GET['mobile_no'].'&filter='.$_GET['filter'];?>" class="form-control input-sm">
...
<button class="btn btn-default" onclick="contactedit('<?php echo $fetch_list->contact_id;?>')" href='#editContact' type="button" data-toggle="modal" data-backdrop='static' data-keyboard='false'><i class="icon-pencil"></i></button>
<?php
$pri_col='contact_id';
