...
<input type="text"  name="sku_no" class="form-control" value="<?php echo $fetch_list->sku_no; ?>" required/>
</div> 
...
<div class="col-sm-4" id="regid"> 
<input type="number" step="any" name="unitprice_purchase" value="<?php echo $fetch_list->unitprice_purchase; ?>" class="form-control" >
</div> 
<label class="col-sm-2 control-label">Sale Price:</label> 
<div class="col-sm-4" id="regid"> 
<input type="number" step="any" name="unitprice_sale" value="<?php echo $fetch_list->unitprice_sale; ?>" class="form-control" >
</div> 
</div>
...
<div class="col-sm-4" id="regid"> 
<textarea type="text" name="description" class="form-control"/><?php  echo $fetch_list->description;?></textarea>
</div> 
