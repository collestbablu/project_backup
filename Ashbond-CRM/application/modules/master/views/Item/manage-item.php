...
<ol class="breadcrumb breadcrumb-2"> 
	...
	<li><a>Master</a></li> 
	<li><a>Product</a></li> 
	<li class="active"><strong><a>Manage Product</a></strong></li> 
...
<input type="text" class="form-control" name="sku_no" value="" required> 
</div> 
<label class="col-sm-2 control-label">*Product Name:</label> 
<div class="col-sm-4"> 
<input name="item_name"  type="text" value="" class="form-control"  required> 
</div> 
</div>
...
<div class="col-sm-4" id="regid"> 
<input type="number" name="unitprice_purchase" min="1" step="any" value="" class="form-control" >
</div> 
<label class="col-sm-2 control-label">Sale Price:</label> 
<div class="col-sm-4" id="regid"> 
<input type="number" name="unitprice_sale" min="1" step="any" value=""  class="form-control" >
</div> 
</div>
...
<div class="col-sm-4" id="regid"> 
<input type="number" name="gst_tax" min="1" step="any" value="" class="form-control">
</div> 
</div>
...
<div class="col-sm-4" id="regid"> 
<input type="file" name="image_name" accept="image/*" onchange="loadFile(event)" /><?php if($fetch_list->product_image!=''){?><img src="<?php echo base_url().'assets/image_data/'.$fetch_list->product_image;?>" height="50" width="50" /> <?php } else {?><img src="<?php echo base_url()?>assets/images/no_image.png" height="50" width="50" /><?php }?>
</div> 
</div>
...
<label>Show
<select name="DataTables_Table_0_length" url="<?=base_url('master/Item/manage_item').'?sku_no='.$_GET['sku_no'].'&hsn_code='.$_GET['hsn_code'].'&productname='.$_GET['productname'].'&description='.$_GET['description'].'&category='.$_GET['category'].'&usageunit='.$_GET['usageunit'].'&unitprice_purchase='.$_GET['unitprice_purchase'].'&gst_tax='.$_GET['gst_tax'].'&unitprice_sale='.$_GET['unitprice_sale'].'&filter='.$_GET['filter'];?>" aria-controls="DataTables_Table_0" id="entries" class="form-control input-sm">
...
<th>
<?php if($fetch_list->product_image!=''){?><img src="<?php echo base_url().'assets/image_data/'.$fetch_list->product_image;?>" height="50" width="50" /> <?php } else {?><img src="<?php echo base_url()?>assets/images/no_image.png" height="50" width="50" /><?php }?> 
</th>
...
<label class="col-sm-2 control-label">*Item/Part No.:</label> 
<div class="col-sm-4"> 	
<input type="text"  name="sku_no" class="form-control" readonly="" value="<?php echo $fetch_list->sku_no; ?>" required />
</div> 
<label class="col-sm-2 control-label">*Product Name:</label> 
<div class="col-sm-4"> 
...
<label class="col-sm-2 control-label">Purchase Price:</label> 
<div class="col-sm-4" id="regid"> 
<input type="number" step="any" name="unitprice_purchase" readonly="" value="<?php echo $fetch_list->unitprice_purchase; ?>" class="form-control" >
</div> 
<label class="col-sm-2 control-label">Sale Price:</label> 
<div class="col-sm-4" id="regid"> 
<input type="number" step="any" name="unitprice_sale" readonly="" value="<?php echo $fetch_list->unitprice_sale; ?>" class="form-control" >
</div> 
</div>
...
<label class="col-sm-2 control-label">Description:</label> 
<div class="col-sm-4" id="regid"> 
<textarea type="text" name="description" class="form-control" readonly="readonly"/><?php  echo $fetch_list->description;?></textarea>
</div> 
<label class="col-sm-2 control-label">Image:</label> 
<div class="col-sm-4" id="regid"> 
<input type="file" name="image_name" accept="image/*" onchange="loadFile(event)" /><?php if($fetch_list->product_image!=''){?><img src="<?php echo base_url().'assets/image_data/'.$fetch_list->product_image;?>" height="50" width="50" /> <?php } else {?><img src="<?php echo base_url()?>assets/images/no_image.png" height="50" width="50" /><?php }?>
