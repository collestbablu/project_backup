...
<?php } else { 
if($mod_fetch->module_name=='Lead')
{
//echo "<li class='has-sub'>"; 
?>
<a href="#" onclick="window.location='<?=base_url();?>crm/Lead/manage_lead'"><i  class="<?php echo $mod_fetch->module_url; ?>"></i><span class="title"><?php echo $mod_fetch->module_name; ?></span></a> 
<?php } else { 
if($mod_fetch->module_name=='Activity')
{
//echo "<li class='has-sub'>"; 
?>
<a href="#" onclick="window.location='<?=base_url();?>activity/Activity/manage_activity'"><i  class="<?php echo $mod_fetch->module_url; ?>"></i><span class="title"><?php echo $mod_fetch->module_name; ?></span></a> 
<?php } else { 
if($mod_fetch->module_name=='Tour')
{
//echo "<li class='has-sub'>"; 
?>
<a href="#" onclick="window.location='<?=base_url();?>tour/Tour/manage_tour'"><i  class="<?php echo $mod_fetch->module_url; ?>"></i><span class="title"><?php echo $mod_fetch->module_name; ?></span></a> 
<?php } else { 
