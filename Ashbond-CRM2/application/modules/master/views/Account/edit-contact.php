...
<div class="col-sm-4"> 
<input type="number" name="mobile" value="<?php echo $fetch_list->mobile;?>" class="form-control" required>
</div>  
...
<div class="col-sm-4"> 
<input type="text" name="gst_no" value="<?php echo $fetch_list->gst;?>" class="form-control">
</div>  
<label class="col-sm-2 control-label">IT Pan:</label> 
<div class="col-sm-4"> 
<input type="text" name="it_pan" value="<?php echo $fetch_list->IT_Pan;?>"  class="form-control">
</div> 
</div>-->
...
<div class="col-sm-4"> 
<textarea class="form-control" name="address3" style="height:150px;"><?php echo $fetch_list->address3;?></textarea>
</div>
-->
</div>
