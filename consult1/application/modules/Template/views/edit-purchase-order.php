...
<td style="display:none"><input type="hidden" name="invoiceid" class="span6 " value="<?php echo $branchFetch->template_hdr_id;?>" readonly size="22" aria-required='true' /></td>
...
<!--===================================== Start search item row======================================================================-->
    ...
    <!-- discount direct price --></td>
		...
		<td> 
						 <input type="number" name="per" id="per"  style="width:120px;" placeholder="Per" value="">	
...
var varR=varRemark/1000;

var totalWeight=(Number(varR)*(Number(varPer))/100);

//var totalNetWeigth=Number(varR)-Number(totalWeight);
...
document.getElementById("tph").value=totalWeight.toFixed(2);
document.getElementById("remark").value=totalWeight.toFixed(2);
document.getElementById("nph").value=runnerTot.toFixed(2);
document.getElementById("tph").value=totalNetWeigth.toFixed(2);
