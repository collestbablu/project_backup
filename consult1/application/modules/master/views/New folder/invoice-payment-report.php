 ...
 $dd=$line->date;
   ...
   <tr>
	...
	<td><?php if($line->status=='payment'){?>
	    ...
	    <a ><img src="<?php echo base_url();?>/assets/images/delete.png" alt="" border="0" class="icon" title="Delete" onclick="openpopup('invoice_correction',650,400,'id=','<?php echo $line->id;?>')" /></a></td>
