...
//
	...
	$rejSql =$this->db->query("select * from tbl_qa_hdr where lot_no ='".$line->lot_no."'");
	$getRej = $rejSql->row();
...
?>
					  ...
					  <td><?php echo  $resultname->Product_typeid;?></td>
					   ...
					   <td><?php echo $line->quantity-$getRej->rejection_qty; ?></td>
					   <td><?php echo $getRej->rejection_qty; ?></td>
