...
$cntQty=$this->db->query("select SUM(quantity) as qty,SUM(rejection_qty) as rejqty from tbl_defleshing_log where lot_no='$line->lot_no'");
$cntfetch=$cntQty->row();
...
?>
					  ...
					  <td><?php echo  $resultname->Product_typeid;?></td>
					   ...
					   <td><?php echo $line->quantity; ?></td>
					    <td ><?php echo $cntfetch->qty;?></td>
					   
                       <td><?php echo ($line->quantity-$cntfetch->qty);?></td>
...
<img src="<?php echo base_url();?>/assets/images/edit.png"  alt="" height="26" border="0" class="icon" title="Edit" onClick="openpopup('updateDefleshing',1200,600,'id',<?php echo $line->wip_hdr_id; ?>)" />
<?php
