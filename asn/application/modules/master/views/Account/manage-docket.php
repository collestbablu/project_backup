...
<th><input name="cid[]" checked="checked" type="checkbox" id="cid[]" class="sub_chk" data-id="<?php echo $list[$i]['13']; ?>" value="<?php echo $list[$i]['13'];?>" /></th>
<th><?php echo $j;?></th>
<th><?=$list[$i]['1'];?></th>
<th><?=$list[$i]['2'];?></th>
<th><?=$list[$i]['3'];?></th>
...
$table_name_dtl='tbl_docket_entry_dtl';
	?>
	&nbsp;&nbsp;&nbsp;<a href="#" id="<?php echo $list[$i]['13']."^".$table_name."^".$pri_col; ?>" class="delbuttondocket icon"><i class="glyphicon glyphicon-remove"></i></a> 
