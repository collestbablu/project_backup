...
?>
	 ...
	 <div class="main-content">
		...
		<form action="delivery_status" method="post">					<div class="table-responsive">
...
<a href="#" onClick="openpopup('update_docket',1200,500,'view',<?=$list[$i]['13'];?>)"><i class="glyphicon glyphicon-zoom-in"></i></a><?php
$pri_col='id';
