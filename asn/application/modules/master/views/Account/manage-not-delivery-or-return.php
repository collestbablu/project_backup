...
<a href="#" onClick="openpopup('update_docket',1200,500,'view',<?=$list[$i]['13'];?>)"><i class="glyphicon glyphicon-zoom-in"></i></a>&nbsp;&nbsp;&nbsp; <input style="display:none" type="button" id="<?php echo $i; ?>" value="Update" onclick="mainshut(this.id)" />&nbsp;&nbsp;
