				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading clearfix">
							<h4 class="panel-title"><strong>Docket Booked</strong></h4>
...
<tr>
		...
		<th>EDD</th>
        <th>Status</th>
        <th style="display:none">Choose Status</th>
		 <th style="display:none">Shipment Delivered On</th>
...
<th style="display:none"><select name="booked_status" id="booked_status<?php echo $i; ?>" >
<option value="">---select--</option>
<option value="Booked">booked</option>
<option value="Not Delivered">Not Delivered</option>
</select>
</th>
<th style="display:none"><input type="date" name="shipment_delivered_on" id="shipment_delivered_on<?php echo $i; ?>" style="width:120px;" /></th>
<th style="display:none"><input type="text" name="shipment_delivered_on_time" id="shipment_delivered_on_time<?php echo $i; ?>"  style="width:60px;" /></th>
