...
<select name="v_name"  class="form-control">
        ...
        <?php 
		$sql = $this->db->query("select * from tbl_contact_m where group_name='3' and status='A' order by first_name asc");
...
<th><?php echo $rows->purchaseid; ?></th>
<th><?php
...
<th><?php echo $rows->service_charge; ?></th>
